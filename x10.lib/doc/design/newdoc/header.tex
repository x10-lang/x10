...
\input {deploy}
\input {design-overview-atomics}
\input {design-overview-sharedarrays}
%\input {design-overview-intrinsics}
\input {design-overview-execenv}
...
\appendix
\section{Background}
\input {background-x10}
\input {background-mpi}
\input {background-lapi}
\input {background-armci}
\input {background-gasnet}
\input{x10-compiler-writer-notes}
