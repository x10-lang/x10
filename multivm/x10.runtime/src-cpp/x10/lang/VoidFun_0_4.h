    ...
    namespace lang {
        ...
        template<class P1, class P2, class P3, class P4> class VoidFun_0_4 : public x10aux::AnyFun {
            ...
            template <class I> struct itable {
                itable(void(I::*apply)(P1,P2,P3,P4),
            ...
            static void apply(x10aux::ref<x10::lang::Reference> recv, P1 arg1, P2 arg2, P3 arg3, P4 arg4) {
                return (recv.operator->()->*(x10aux::findITable<VoidFun_0_4<P1,P2,P3,P4> >(recv->_getITables())->apply))(arg1, arg2, arg3, arg4);
            }
