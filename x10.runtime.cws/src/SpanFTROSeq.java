 ...
 * A purely sequential version, with no parallellism associated overhead. Intended to be used
 * as the basis for speedup numbers.
 */

import java.util.concurrent.atomic.AtomicIntegerFieldUpdater;


public class SpanFTROSeq {
	...
	public SpanFTROSeq (int n, int m){
		N=n;
		M=m;
