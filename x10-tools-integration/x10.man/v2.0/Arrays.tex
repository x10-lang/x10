...
\limitation{This chapter is obsolete and needs extensive revision.}

This chapter provides an overview of the class \Xcd{Array}, and its supporting
classes \Xcd{Point}, \Xcd{Region} and \Xcd{Dist}. All these classes are in the 
\Xcd{x10.lang} package. For more details, please consider the API documentation.
...
\bard{The following section is material from the Types chapter that needs to
be nicely integrated into this chapter}
...
\checkme{Huh? Why do we say rail constructor above? As opposed to just any old valrail?}
\begin{xten}
p: Point(2) = [1,2];
\end{xten}
...
\xcd"i"th element of a point \xcd"p" may be accessed as \xcd"p(i)".
