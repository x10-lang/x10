...
%~~gen
%package Arrays.Regions.RailOfPoints;
%class Example{
%def example() {
%~~vis
\begin{xten}
...
\xcdmath"R$_2$"; \viz, the points in \xcdmath"R$_1$" which are not in \xcdmath"R$_2$".\index{region!set difference}
...
forward and backward by \xcdmath"p". That is, \Xcd{R+p} is the set of points
