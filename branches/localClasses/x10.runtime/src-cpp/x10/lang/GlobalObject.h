...
#ifndef X10_LANG_GLOBAL_OBJECT_H
#define X10_LANG_GLOBAL_OBJECT_H
...
namespace x10 {
    namespace lang {
        ...
        class GlobalObject : public Reference {
        private:
        ...
        public:
            ...
            static x10aux::ref<GlobalObject> _make();

            x10aux::ref<GlobalObject> _constructor() {
            ...
            virtual x10aux::serialization_id_t _get_interface_serialization_id() {
                _S_("===> GlobalObject's _get_interface_serialization_id() called");
            ...
            static void _serialize_reference(x10aux::ref<GlobalObject> this_,
                                             x10aux::serialization_buffer &buf);
            ...
            // Client responsible for checking for null
            static GlobalObject::_reference_state _deserialize_reference_state(x10aux::deserialization_buffer &buf) {
                _reference_state rr;
            ...
            template<class R> static x10aux::ref<R> _finalize_reference(x10aux::ref<GlobalObject> res, GlobalObject::_reference_state rr, x10aux::deserialization_buffer &buf);
            ...
            static void dealloc_object(GlobalObject*);
        };

        template<class T> x10aux::ref<T> GlobalObject::_deserializer(x10aux::deserialization_buffer &buf) {
            x10aux::ref<GlobalObject> this_ = new (x10aux::alloc_remote<GlobalObject>()) GlobalObject();
            buf.record_reference(this_);
            this_->_deserialize_body(buf);
            return this_;
        }

        template<class T> x10aux::ref<T> GlobalObject::_deserialize(x10aux::deserialization_buffer &buf) {
            // extract the id
            x10aux::serialization_id_t id = buf.read<x10aux::serialization_id_t>();
            _reference_state rr = _deserialize_reference_state(buf);
            x10aux::ref<GlobalObject> res;
            if (rr.ref != 0) {
        ...
        template<class R> x10aux::ref<R> GlobalObject::_finalize_reference(x10aux::ref<GlobalObject> obj, GlobalObject::_reference_state rr, x10aux::deserialization_buffer &buf) {
            if (rr.ref == 0) {
                return x10aux::null;
            }
