...
public class NewTupleInstruction extends SSAInstruction {
    private int retValue;

    private int childValues[];

    public NewTupleInstruction(int result, int[] childValues) {
        super();
    ...
    public SSAInstruction copyForSSA(SSAInstructionFactory insts, int[] defs, int[] uses) {
        NewTupleInstruction copy = ((X10InstructionFactory) insts).NewTuple((defs != null) ? defs[0] : retValue,
                childValues);
