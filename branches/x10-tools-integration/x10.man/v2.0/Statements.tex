...
result.  Side effects of the expression occur.  
The expression must be either an assignment, an
allocation, or a call; \viz, a sort of expression which could possibly have
side effects. 
%~~gen
...
%} } 
%~~neg
\bard{When XTENLANG-1434 has been fixed, add a 'continue lbl' to this example}
