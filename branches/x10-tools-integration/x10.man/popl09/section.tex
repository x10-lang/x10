...
\newcommand\IXGL[1]{{\sf IXG(${\cal #1}$)}}
\def\IXGZ{\IXGL{\cdot}}
\def\IXGD{\IXGL{Q}}
\def\IXG{{\sf IXG}\xspace}
...
\def\RNew{\mbox{\sc R-New}}
\def\RCCast{\mbox{\sc RC-Cast}}
\def\RAss{\mbox{\sc R-Asst}}
\def\RCAssLHS{\mbox{\sc RC-Ass-LHS}}
\def\RCAssRHS{\mbox{\sc RC-Ass-RHS}}
