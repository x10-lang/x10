...
namespace x10 {
    namespace lang {
        ...
        template<class P1, class P2, class P3, class P4, class P5, class P6> class VoidFun_0_6 : public x10aux::AnyFun {
            ...
            struct itable {
                itable(void(*apply)(x10aux::ref<VoidFun_0_6<P1,P2,P3,P4,P5,P6> >, P1,P2,P3,P4,P5,P6)) : apply(apply) {}
                void (*apply)(x10aux::ref<VoidFun_0_6<P1,P2,P3,P4,P5,P6> >, P1,P2,P3,P4,P5,P6);
            };
        };

        template<class P1, class P2, class P3, class P4, class P5, class P6>
            const x10aux::RuntimeType* VoidFun_0_6<P1,P2,P3,P4,P5,P6>::_initRTT() {
