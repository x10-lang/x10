...
/**
 * The AStore instruction class.
 *
 * The header comment for {@link Instruction} contains
 * an explanation of the role of these interior class in 
 * opt compiler's IR.
 */
public abstract class AStore extends Instruction
  ...
  /**
    ...
    * @param guard
    */
  AStore (Operand value, Operand array, Operand index, FieldOperand field, Operand guard) {
    this.value = value;
    this.array = array;
    this.index = index;
    this.field = field;
