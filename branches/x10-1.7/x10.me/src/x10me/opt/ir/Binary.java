...
/**
 * The Binary instruction class.
 *
 * The header comment for {@link Instruction} contains
 * an explanation of the role of these interior class in 
 * opt compiler's IR.
 */
public abstract class Binary extends Instruction
  ...
  /**
    ...
    * @param val2
    */
  Binary (Operand result, Operand val1, Operand val2) {
    this.result = result;
    this.val1 = val1;
    this.val2 = val2;
  }
   ...
   * @return the copy
   */
  public Binary create(Operand result, Operand val1, Operand val2) {
    Binary copy = (Binary)copyWithoutLinks();
    copy.result = result;
    copy.val1 = val1;
    copy.val2 = val2;
    return copy;
