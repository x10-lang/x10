 ...
 * @author vj 12/2004
 */
public value class ClockQueensList {
	// Operations and data structures for a list of queen coordinates

	// Since ClockQueensList is an immutable value class,
	 ...
	 */
	public ClockQueensList(final int value [.] oldList, final int newItem) {
