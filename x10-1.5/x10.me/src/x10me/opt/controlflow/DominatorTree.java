...
public class DominatorTree extends Tree {
  ...
  public static void perform(IR ir, boolean forward) {
	...
	ir.dumpFile.current.println("Here is the CFG for method " + ir.method.getName() + "\n" + ir.cfg);
        ir.dumpFile.current.println("Here is the Dominator Tree for method " +
                           ir.method.getName() + "\n" +
                           ir.dominatorTree);
      }
    } else {
	...
	ir.dumpFile.current.println("Here is the CFG for method " + ir.method.getName() + "\n" + ir.cfg);
        ir.dumpFile.current.println("Here is the Post-Dominator Tree for method " +
                           ir.method.getName() + "\n" +
  ...
  public DominatorTree(IR ir, boolean forward) {
	...
	if (ir.dumpFile.current != null)
          ir.dumpFile.current.println("info field is null for block: " + block);
      }
