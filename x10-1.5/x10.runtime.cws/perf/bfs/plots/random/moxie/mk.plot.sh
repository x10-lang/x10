...
#
# $Id: mk.plot.sh,v 1.1 2008-02-25 11:34:30 srkodali Exp $
#
...
printf "set title \"BFS:Random [Moxie/1M]\"\n" >> $tmp_file
...
printf "set title \"BFS:Random [Moxie/4M]\"\n" >> $tmp_file
...
printf "set title \"BFS:Random [Moxie/9M]\"\n" >> $tmp_file
