...
namespace x10 {
    namespace lang {
        ...
        extern const x10aux::RuntimeType* _initRTTHelper_VoidFun_0_8(const x10aux::RuntimeType **location,
        ...
        template<class P1, class P2, class P3, class P4, class P5, class P6, class P7, class P8>
            const x10aux::RuntimeType* VoidFun_0_8<P1,P2,P3,P4,P5,P6,P7,P8>::_initRTT() {
            return x10::lang::_initRTTHelper_VoidFun_0_8(&rtt, x10aux::getRTT<P1>(), x10aux::getRTT<P2>(), 
