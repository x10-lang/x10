...
namespace x10 {
    namespace lang {
        ...
        extern const x10aux::RuntimeType* _initRTTHelper_Fun_0_5(const x10aux::RuntimeType **location,
        ...
        template<class P1, class P2, class P3, class P4, class P5, class R> class Fun_0_5 : public x10aux::AnyFun {
            ...
            template <class I> struct itable {
                itable(R(I::*apply)(P1,P2,P3,P4,P5)) : apply(apply) {}
                R (I::*apply)(P1,P2,P3,P4,P5);
            };
        };

        template<class P1, class P2, class P3, class P4, class P5, class R>
            const x10aux::RuntimeType* Fun_0_5<P1,P2,P3,P4,P5,R>::_initRTT() {
            return x10::lang::_initRTTHelper_Fun_0_5(&rtt, x10aux::getRTT<P1>(), x10aux::getRTT<P2>(), 
                                                     x10aux::getRTT<P3>(), x10aux::getRTT<P4>(), 
                                                     x10aux::getRTT<P5>(), x10aux::getRTT<R>());
        }
        
        template<class P1, class P2, class P3, class P4, class P5, class R>
            const x10aux::RuntimeType* Fun_0_5<P1,P2,P3,P4,P5,R>::rtt = NULL;
    }
}
#endif
