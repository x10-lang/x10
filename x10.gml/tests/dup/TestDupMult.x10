...
public class TestDupMult extends x10Test {
    ...
    public def testDupDup():Boolean {
        ...
        DenseMatrixBLAS.comp(ET(1.0), da, db, ET(0.0), dc);
    ...
    public def testDupTransDup():Boolean {
        ...
        val db = b.getMatrix();
        val dc = DenseMatrix.make(M,N);
        DenseMatrixBLAS.compTransMult(ET(1.0), da, db, ET(0.0), dc);
    ...
    public def testDupDupTrans():Boolean {
        ...
        val db = b.getMatrix();
        val dc = DenseMatrix.make(M,N);
        DenseMatrixBLAS.compMultTrans(ET(1.0), da, db, ET(0.0), dc);
    ...
    public def testDupDense():Boolean{
        ...
        val da = a.getMatrix();
        val dc = DenseMatrix.make(M,N);
        DenseMatrixBLAS.comp(ET(1.0), da, b, ET(0.0), dc);
