...
public class TestTriSparse extends x10Test {
    ...
    public def this(m:Long, nd:Float) {
        M = m;
        nzd = nd;
    }
    ...
    public def testUpper():Boolean{
        ...
        val uplo = true;
        val ss = SparseCSCBuilder.make(M,M).initRandom(nzd, (r:Long,c:Long)=>ET(1.0+r+c*M)).toSparseCSC();
    ...
    public static def main(args:Rail[String]) {
        ...
        val d = (args.size > 1) ? Float.parse(args(1)):1.0f;
