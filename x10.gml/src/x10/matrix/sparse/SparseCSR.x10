...
public class SparseCSR extends Matrix {
         ...
         */
        public def init(v:ElemType, sp:Float):SparseCSR(this) {
         ...
         */
        public def initRandom(sp:Float) : SparseCSR(this) {
        ...
        public def initRandom(lo:Long, up:Long, nzp:Float): SparseCSR(this) {
         ...
         * For testing purpose.
         */
        public static def makeRand(m:Long, n:Long, nzd:Float): SparseCSR(m, n) {
