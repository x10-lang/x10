...
// Intended to be included from wrap_lapack.cc
...
*/
#if defined(__essl__)
void sgesv(int* N, int* NRHS, ElemType* A, int* LDA, int* IPIV, ElemType* B, int* LDB, int* INFO);
#else
void sgesv_(int* N, int* NRHS, ElemType* A, int* LDA, int* IPIV, ElemType* B, int* LDB, int* INFO);
#endif
...
*     .. Scalar Arguments ..
      ...
      DOUBLEg PRECISION   ABSTOL, VL, VU
*     ..
*     .. Array Arguments ..
      INTEGER            IFAIL( * ), IWORK( * )
...
*/
#if defined(__essl__)
  void ssyevx(char* JOBZ, char* RANGE, char* UPLO, int* N, ElemType* A, int* LDA, ElemType* VL, ElemType* VU, int* IL, int* IU, ElemType *ABSTOL, int *M, ElemType* W, ElemType* Z, int* LDZ, ElemType* WORK, int* LWORK, int* IWORK, int* IFAIL, int* INFO );
#else
  void ssyevx_(char* JOBZ, char* RANGE, char* UPLO, int* N, ElemType* A, int* LDA, ElemType* VL, ElemType* VU, int* IL, int* IU, ElemType *ABSTOL, int *M, ElemType* W, ElemType* Z, int* LDZ, ElemType* WORK, int* LWORK, int* IWORK, int* IFAIL, int* INFO );
#endif
...
#if defined(__essl__)
    ssyevx(&JOBZ, &RANGE, &UPLO, &N, A, &LDA,
           NULL, NULL, // VL, VU
           NULL, NULL, // IL, IU
           &ABSTOL, &M, W, NULL, &LDZ,
           WORK, LWORK, IWORK, NULL, &INFO);
#else
    ssyevx_(&JOBZ, &RANGE, &UPLO, &N, A, &LDA,
           NULL, NULL, // VL, VU
           NULL, NULL, // IL, IU
           &ABSTOL, &M, W, NULL, &LDZ,
           WORK, LWORK, IWORK, NULL, &INFO);
