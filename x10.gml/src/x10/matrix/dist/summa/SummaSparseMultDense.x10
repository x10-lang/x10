...
public class SummaSparseMultDense {
	 ...
	 */
	protected def this(ps:Int, be:Double,
					a:DistSparseMatrix, 
					b:DistDenseMatrix, 
					c:DistDenseMatrix) {
		//Check panelsize
	...
	//=====================================================================
	public static def estPanelSize(dA:DistSparseMatrix, dB:DistDenseMatrix):Int {
		...
		val ldm = Math.max(ldm_b, ((1.0/l_nzd)* ldm_a) as Int);
