...
public class SummaExample{
    ...
    static class RunSummaExample(M:Long, N:Long, K:Long, nzd:Float) {
        public val pA:Grid;
        public val pB:Grid;
        public val pC:Grid;
	    ...
	    SummaDense.mult(1, 0.0 as ElemType, da, db, dc);
	    ...
	    SummaDense.multTrans(1, 0.0 as ElemType, da, db, dc);
	    Debug.flushln("SUMMA done");
	    ...
	    SummaSparse.mult(1, 0.0 as ElemType, da, db, dc);
	    Debug.flushln("SUMMA done");
	    ...
	    SummaSparse.multTrans(1, 0.0 as ElemType, da, db, dc);
	    Debug.flushln("SUMMA done");
