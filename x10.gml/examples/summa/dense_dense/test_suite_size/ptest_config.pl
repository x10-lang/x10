...
printf "\#Setting SUMMA dense matrix multiplication scalability test on matrix size\n";
...
@MatrixRows =  ( 800, 1600, 3200, 6400, 12800 );
printf "\#Set matrix row list                 : ( @MatrixRows )\n";
...
$RunOpts = "2048 2048 $itnum $panelsize";
