...
printf "\#Setting SUMMA sparse matrix multiplication scalability test on panel size\n";
...
@PanelList =  ( 200, 400, 600, 800, 1000 );
...
$RunOpts = "10000 10000 10000 $NZDensity $itnum";
