...
printf "\#Linear regression scalability benchmark test on problem size\n";
...
@MatrixSizeList = ( 10000000, 20000000, 30000000, 40000000, 50000000, 60000000, 70000000, 80000000, 90000000, 100000000 );
