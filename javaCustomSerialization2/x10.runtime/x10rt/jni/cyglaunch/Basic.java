...
public class Basic {
    ...
    private static final short _RunnableWithBuf_id = x10.x10rt.DeserializationDispatcher.addDispatcher(RunnableWithBuf.class.getName());
    private static final short _Handler_id = x10.x10rt.DeserializationDispatcher.addDispatcher(Handler.class.getName());
