...
public final class Foreach1 {
    ...
    public static final class Block {
        ...
        public static @Inline operator for(range: LongRange,
            ...
            Foreach1.Block.slice(range.min, range.max, executeRange);
        }
             ...
             if (Runtime.NTHREADS == 1n) {
                 ...
                 finish for (var t:Long = Runtime.NTHREADS-1; t >= 0; t--) {
                     ...
                     async {
                         ...
                         Foreach1.Sequential.operator for(block, body);
                     }
                 }
             }
         }
        ...
        public static @Inline def reduce[T](range:LongRange,
            ...
            return Foreach1.Block.reduceSlice(range.min, range.max, executeRange, combine);
        }
    ...
    public static final class Bisect {
        ...
        public static @Inline def slice(min:Long, max:Long,
            ...
            Foreach1.Bisect.slice(min, max, grainSize, body);
        }
        ...
        public static @Inline operator for(range: LongRange,
            ...
            Foreach1.Bisect.for_(range, grainSize, body);
        }
        ...
        public static @Inline def reduceSlice[T](min:Long, max:Long,
                                                 ...
                                                 reduce:(a:T,b:T)=>T):T {
            val grainSize = Math.max(1, (max-min) / (Runtime.NTHREADS*8));
            return Foreach1.Bisect.reduceSlice(min, max, grainSize, body, reduce);
        }
        ...
        public static @Inline def reduce[T](range:LongRange,
					    ...
					    reduce:(a:T,b:T)=>T, identity:T):T {
            val grainSize = Math.max(1, (range.max-range.min) / (Runtime.NTHREADS*8));
            return Foreach1.Bisect.for_(range, grainSize, body, reduce, identity);
        }
	...
	public static @Inline def slice(min0:Long, max0:Long,
	    ...
	    Foreach1.Bisect.slice(min0, max0, min1, max1, grainSize0, grainSize1, body);
	}
	 ...
	 */
        public static @Inline operator for (space:DenseIterationSpace_2,
            ...
            Foreach1.Bisect.slice(space.min0, space.max0, space.min1, space.max1, grainSize0, grainSize1, executeRange);
        }
	 ...
	 */
	    ...
	    Foreach1.Bisect.operator for (space, grainSize0, grainSize1, body);
	}
