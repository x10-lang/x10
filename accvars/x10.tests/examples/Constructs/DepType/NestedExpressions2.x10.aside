...
public class NestedExpressions2 extends x10Test {
	class C(a:boolean) {
		...
		def n() {
			...
			// Warning: Expression 'NestedExpressions2.C.this.and(x, y)' 
			// was cast to type NestedExpressions2.C{self.NestedExpressions2.C#a
			// ==y.NestedExpressions2.C#a, x.NestedExpressions2.C#a}.
		}
	}
    public def run() = true;
