 ...
 *
 */
/* An X10 implementation of AbstractList
 * 
...
public abstract class AbstractList extends AbstractCollection implements List {
     ...
     */
    abstract public nullable<Object> get(int index);
	...
	public nullable<Object> next() {
	    ...
	    try {
		nullable<Object> next = get(cursor);
		lastRet = cursor++;
		return next;
	...
	public boolean hasPrevious() {
        ...
        public nullable<Object> previous() {
            ...
            try {
                int i = cursor - 1;
                nullable<Object> previous = get(i);
                lastRet = cursor = i;
                return previous;
            } catch(IndexOutOfBoundsException e) {
                checkForComodification();
	...
	while(e1.hasNext() && e2.hasNext()) {
	    nullable<Object> o1 = e1.next();
	    nullable<Object> o2 = e2.next();
...
class SubList extends AbstractList {
    ...
    public nullable<Object> remove(int index) {
        rangeCheck(index);
        checkForComodification();
        nullable<Object> result = l.remove(index+offset);
        expectedModCount = l.modCount;
        size--;
        modCount++;
        return result;
