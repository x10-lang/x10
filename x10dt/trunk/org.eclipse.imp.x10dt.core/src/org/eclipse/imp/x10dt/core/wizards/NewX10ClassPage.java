...
public class NewX10ClassPage extends NewTypeWizardPage {
    ...
    private void doCreateType(String typeName, IPackageFragment pkgFrag, String superClass, List/*
                                                                                                 * <String
                                                                                                 * >
                                                                                                 */superIntfs, IProgressMonitor monitor) throws CoreException {
     ...
     * @param sourceFile
     */
    protected static InputStream createContentStream(IFile sourceFile, String typeName, IPackageFragment pkgFrag, String superClass, List<String> superIntfs, boolean createMain,
    ...
    /**
     * Initialize the given file's contents with sample source code. e.g. for
     * "Hello World"
     * 
     * @param sourceFile
     */
    // TODO This should be merged with WizardUtils.createSampleContentStream()
    // from x10dt.ui.launch.core
    protected static InputStream createSampleContentStream(IFile sourceFile, String typeName, IPackageFragment pkgFrag, String superClass, List<String> superIntfs, boolean createMain,
