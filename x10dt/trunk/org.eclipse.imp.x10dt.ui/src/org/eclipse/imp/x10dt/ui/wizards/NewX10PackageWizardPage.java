...
public class NewX10PackageWizardPage extends NewContainerWizardPage {
   ...
   * @param canBeModified
   *          if <code>true</code> the package input field can be modified; otherwise it is read-only.
   */
   ...
   * 
   * @param monitor
   *          a progress monitor to report progress. The progress monitor must not be <code>null</code>
