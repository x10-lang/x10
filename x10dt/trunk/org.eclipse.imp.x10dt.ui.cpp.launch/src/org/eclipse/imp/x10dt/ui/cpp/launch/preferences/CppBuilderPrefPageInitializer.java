...
public class CppBuilderPrefPageInitializer extends AbstractPreferenceInitializer {
  ...
  private static final String COMPILE_CMD = "g++ -I${X10_DIST_LOC}/include -I${PGAS_LOC}/include"; //$NON-NLS-1$

  private static final String ARCHIVE_CMD = "ar r $workspace_dir/$lib_name.a $workspace_dir/*.o"; //$NON-NLS-1$
  
  private static final String LINK_CMD = "g++ -DTRANSPORT=sockets -L${PGAS_LOC}/lib -L${X10_DIST_LOC}/lib -I${PGAS_LOC}/include -I${X10_DIST_LOC}/include"; //$NON-NLS-1$
