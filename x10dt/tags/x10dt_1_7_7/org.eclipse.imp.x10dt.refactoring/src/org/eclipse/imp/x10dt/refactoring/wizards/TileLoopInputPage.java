...
public class TileLoopInputPage extends UserInputWizardPage implements Listener {
    private Text fText;

    public TileLoopInputPage(String name) {
        super(name);
    }
    ...
    public void createControl(Composite parent) {
        ...
        numTimesLabel.setText("Tiling factor:");
            ...
            public void modifyText(ModifyEvent e) {
                ...
                if (newText.length() > 0) {
                    try {
                        ...
                        TileLoopInputPage.this.setErrorMessage("Tiling factor must be an integral number");
                    }
                }
            }
        });
    ...
    private TileLoopRefactoring getTileLoopRefactoring() {
