 ...
 *
 */
public class InsertMemberChange extends Change {
    private final ClassMember fMember;
    private final ClassDecl fParentClass;
    private final int fPos;

    /**
     * @param name
     */
    public InsertMemberChange(String name, ClassMember member, ClassDecl parentClass, int pos) {
        super(name);
        fMember= member;
