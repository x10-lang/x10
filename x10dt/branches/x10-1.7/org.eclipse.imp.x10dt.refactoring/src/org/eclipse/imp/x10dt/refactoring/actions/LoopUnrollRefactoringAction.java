...
public class LoopUnrollRefactoringAction extends TextEditorAction {
    public LoopUnrollRefactoringAction(ITextEditor editor) {
        super(X10RefactoringMessages.ResBundle, "loopUnroll.", editor);
    }
