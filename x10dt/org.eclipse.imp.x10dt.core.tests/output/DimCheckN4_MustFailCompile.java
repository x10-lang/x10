...
public class DimCheckN4_MustFailCompile
extends harness.
  x10Test
{public static final x10.rtt.RuntimeType<DimCheckN4_MustFailCompile>_RTT = new x10.rtt.RuntimeType<DimCheckN4_MustFailCompile>(
/* base class */DimCheckN4_MustFailCompile.class
    				...
    				new x10.core.fun.VoidFun_0_0() {
    					public void apply() {
    						...
    						try {
    							...
    							DimCheckN4_MustFailCompile.main(args);
...
new DimCheckN4_MustFailCompile().execute();
    ...
    public DimCheckN4_MustFailCompile() {
        super();
    }
