...
public class Array3DoubleSwapped
extends harness.
  x10Test
{public static final x10.rtt.RuntimeType<Array3DoubleSwapped>_RTT = new x10.rtt.RuntimeType<Array3DoubleSwapped>(
/* base class */Array3DoubleSwapped.class
...
//#line 25
return ((double) ia.apply$G((int)(1),
                                                (int)(1))) ==
        ((double) 42.0);
    }
...
/* template:Main { */
    ...
    public static void main(final x10.core.Rail<java.lang.String> id$9241)  {
        
//#line 29
new Array3DoubleSwapped().execute();
    }/* } */
    
    public Array3DoubleSwapped() {
        super();
    }
