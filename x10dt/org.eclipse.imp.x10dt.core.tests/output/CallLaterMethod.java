...
extends harness.
  x10Test
{public static final x10.rtt.RuntimeType<CallLaterMethod>_RTT = new x10.rtt.RuntimeType<CallLaterMethod>(
/* base class */CallLaterMethod.class
