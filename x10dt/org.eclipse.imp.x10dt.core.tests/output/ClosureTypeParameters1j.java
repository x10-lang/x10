...
public class ClosureTypeParameters1j
extends ClosureTest
{public static final x10.rtt.RuntimeType<ClosureTypeParameters1j>_RTT = new x10.rtt.RuntimeType<ClosureTypeParameters1j>(
/* base class */ClosureTypeParameters1j.class
...
this.check("new X[String,int].f(\"1\",1)",
                               new ClosureTypeParameters1j.
                                 X$70<java.lang.String, java.lang.Integer>(x10.rtt.Types.runtimeType(java.lang.String.class),
                                                                           x10.rtt.Types.INT,
                                                                           this).
                                 f.apply$G("1",
                                           1),
    				...
    				new x10.core.fun.VoidFun_0_0() {
    					public void apply() {
    						...
    						try {
    							...
    							ClosureTypeParameters1j.main(args);
...
new ClosureTypeParameters1j().execute();
    ...
    public ClosureTypeParameters1j() {
        super();
    }
    
    
//#line 34
private static class X$70<T, U>
                extends x10.core.Ref
                {public static final x10.rtt.RuntimeType<ClosureTypeParameters1j.
      X$70>_RTT = new x10.rtt.RuntimeType<ClosureTypeParameters1j.
      X$70>(
    /* base class */ClosureTypeParameters1j.
      X$70.class, 
...
//#line 30
final private ClosureTypeParameters1j
          out$;
...
final x10.core.fun.Fun_0_2<T,U,java.lang.String>
        ...
        public X$70(final x10.rtt.Type T,
                    final x10.rtt.Type U,
                    final ClosureTypeParameters1j out$) {
                                                                 super();
                                                             this.T = T;
                                                             this.U = U;
                                                              {
