...
extends ClosureTest
{public static final x10.rtt.RuntimeType<ClosureObject1>_RTT = new x10.rtt.RuntimeType<ClosureObject1>(
/* base class */ClosureObject1.class
...
//#line 25
this.check("(f as ()=>int)()",
                               (int)(java.lang.Integer)(((((x10.core.fun.Fun_0_0)
                                                            f))).apply$G()),
                               (int)(1));
