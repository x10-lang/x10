...
public class ClosureReturnType2_MustFailCompile
extends ClosureTest
{public static final x10.rtt.RuntimeType<ClosureReturnType2_MustFailCompile>_RTT = new x10.rtt.RuntimeType<ClosureReturnType2_MustFailCompile>(
/* base class */ClosureReturnType2_MustFailCompile.class
...
//#line 29
ClosureReturnType2_MustFailCompile.this.foo();
        }}
    				...
    				new x10.core.fun.VoidFun_0_0() {
    					public void apply() {
    						...
    						try {
    							...
    							ClosureReturnType2_MustFailCompile.main(args);
...
new ClosureReturnType2_MustFailCompile().execute();
    ...
    public ClosureReturnType2_MustFailCompile() {
        super();
    }
