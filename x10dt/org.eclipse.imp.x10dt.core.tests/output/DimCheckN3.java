...
public class DimCheckN3
extends harness.
  x10Test
{public static final x10.rtt.RuntimeType<DimCheckN3>_RTT = new x10.rtt.RuntimeType<DimCheckN3>(
/* base class */DimCheckN3.class
