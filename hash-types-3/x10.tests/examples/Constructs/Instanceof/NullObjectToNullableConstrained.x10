...
public class NullObjectToNullableConstrained extends x10Test {
	...
	public def run(): boolean = {
		var array: Rail[X10DepTypeClassOne!]! = Rail.make[X10DepTypeClassOne!](1);
		...
		var res1: boolean = !(array(0) instanceof  X10DepTypeClassOne{p==1});
		
		// var is null hence it is not an instance of targeted non nullable type
		var res2: boolean = !(var instanceof  X10DepTypeClassOne{p==1});
	...
	public def getNullNullable(): Box[X10DepTypeClassOne] = null;
