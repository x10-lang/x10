...
public class RegionConvexHull {
	...
	public boolean run() {
		...
		pr("R1orR2",R1orR2);
		chk(!R1orR2.isConvex());
		final region R1orR2ConvexHull=R1orR2.convexHull();
		...
		final region R1orR2andR3ConvexHull=R1orR2andR3.convexHull();
		...
		final region R1orR2minusR3ConvexHull=R1orR2minusR3.convexHull();
		...
		final region R4=([0:0,4:4]||[1:1,3:3] ||[5:5,2:2]||[3:3,6:6]);
		pr("R4",R4);
		final region R4convexHull=R4.convexHull();
		pr("R4convexHull",R4convexHull);
		// just bounding box
		chk(R4convexHull.equals([0:5,2:6]));
		final region R1andR2=(R1 && R2);
