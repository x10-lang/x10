...
public interface FieldAnnotation extends x10.lang.annotations.Annotation {
...
public static final RTT it = new RTT();
    ...
    public RTT() {super(x10.lang.annotations.FieldAnnotation.class);
                      }
    public boolean instanceof$(java.lang.Object o) {
    if (! (o instanceof x10.lang.annotations.
          FieldAnnotation)) return false;return true;}}
}
