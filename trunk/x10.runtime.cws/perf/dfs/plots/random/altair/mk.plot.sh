...
#
# $Id: mk.plot.sh,v 1.2 2008-02-25 16:35:10 srkodali Exp $
#
...
printf "set title \"DFS:Random [Altair/1M]\"\n" >> $tmp_file
...
printf "set title \"DFS:Random [Altair/4M]\"\n" >> $tmp_file
...
printf "\n" >> $tmp_file
printf "\"${cilk_tbl}\" index 2 using 3:5 title \"Cilk-ST\"" >> $tmp_file
printf "\n" >> $tmp_file


printf "set title \"DFS:Random [Altair/9M]\"\n" >> $tmp_file
