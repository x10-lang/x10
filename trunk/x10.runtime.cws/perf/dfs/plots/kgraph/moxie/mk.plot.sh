...
#
# $Id: mk.plot.sh,v 1.2 2008-02-25 16:28:10 srkodali Exp $
#
...
printf "set title \"DFS:KGraph [Moxie/1M]\"\n" >> $tmp_file
...
printf "set title \"DFS:KGraph [Moxie/4M]\"\n" >> $tmp_file
...
printf "set title \"DFS:KGraph [Moxie/9M]\"\n" >> $tmp_file
