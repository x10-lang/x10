...
\paragraph{}The following example shows how to compute a spanning tree of a connected graph in parallel at one place. A node is in the spanning tree if its field {\tt inTree} is {\tt true}.
\begin{center}
{\small
\begin{verbatim}
public class V{
