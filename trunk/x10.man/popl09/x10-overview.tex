...
use.
\fi
We explore these usability problems in Section~\ref{sec:usability}.
...
The fundamental
\fi
problem is that programmers are used to
...
To correct these problem, the revised \Xten design imposes
restrictions on type properties so that they 
behave similarly to type parameters with definition-site
variance.
...
for method and constructor guards and in class invariants.
