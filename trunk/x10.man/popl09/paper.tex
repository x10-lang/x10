...
\eat{
class Array[T](add: (T,T)=>T) {
    def this[T](){T <: Arithmetic} = { 
        property[T](T.add);
    }
    def this[T](){T <: Array, T.add != null} = { 
        property[T](T.add);
    }
}
}
...
initializes the properties from the formal type and value parameters
...
method where clauses, optional methods
