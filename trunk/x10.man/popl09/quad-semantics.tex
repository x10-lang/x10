...
\begin{itemize}
\item Subject reduction. Having potentially mutiple types for an expression does not make the proof any harder as the subject reduction theorem let us choose {\tt S} among the possible types or ${\tt e}'$.
