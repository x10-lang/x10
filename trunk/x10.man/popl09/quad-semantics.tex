...
First, we assume given a constraint system $\cal A$, with a vocabulary of predicates ${\tt p}$ and functions ${\tt f}$. 0-ary functions denote constants.
...
Third, we authorize users to write constraints (expect for existential constraints) in programs.
