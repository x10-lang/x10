...
\infrule[\RField]
	{\vdash\fields({\tt C}[\tbar{A}])=\tbar{f}:\tbar{F}}
...
\infrule[\RCNewArg]
	...
	{\new~{\tt C}[\tbar{A}](\ldots,{\tt e}_i,\ldots)\derives\new~{\tt C}[\tbar{A}](\ldots,{\tt e}'_i,\ldots)}

\infrule[\RInvk]
	{\vdash{\sf methods}({\tt C}[\tbar{A}]) \ni {\tt m}[\tbar{B}](\tbar{x}:\tbar{G})\{{\tt k}\}:{\tt H}={\tt e}}
	{\new~{\tt C}[\tbar{A}](\tbar{v}).{\tt m}[\tbar{B}](\tbar{a})\derives {\tt e}[\new~{\tt C}[\tbar{A}](\tbar{v}),\tbar{a}/\this,\tbar{x}]}
...
\infrule[\RCast]
	{\vdash{\tt C}[\tbar{A}]\{\self==\new~{\tt C}[\tbar{A}](\tbar{v})\}\subtype {\tt G}}
...
\infrule[OK-Method]
  {{\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}[\tbar{E}]~\{~\tbar{M}~\}\in {\tt P} \andalso
   ...
   \tbar{X}:\type,\tbar{Z}:\type,\this:{\tt C}[\tbar{X}],\tbar{x}:\tbar{G},{\tt l}\vdash {\tt e}:{\tt A},{\tt A}\subtype {\tt H}}
...
\quad\typicallabel{XXXXXX}
\infrule[W-Class]
  {{\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}[\tbar{E}]~\{~\tbar{M}~\} \in {\tt P} \andalso \wj{\Gamma}{{\tt D}[\tbar{E}[\tbar{A}/\tbar{X}]]}}
  {\wj{\Gamma}{\tt C[\tbar{A}]}}
\end{minipage}
...
\infrule[S-Class]
  ...
  \wj{\Gamma}{{\tt C}[\tbar{A}]}}
  {\Gamma\vdash {\tt C}[\tbar{A}]\subtype {\tt D}[\tbar{E}[\tbar{A}/\tbar{X}]]}
\end{minipage}        
...
\infrule[L-Fields-I]
  {{\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}[\tbar{E}]~\{~\tbar{M}~\}\in {\tt P}
   ...
   \Gamma\vdash\fields({\tt D}[\tbar{E}[\tbar{A}/\tbar{X}]])=\tbar{g}:\tbar{G}}
   {\Gamma\vdash\fields({\tt C}[\tbar{A}])=\tbar{g},\tbar{f}:\tbar{G},\tbar{F}[\tbar{A}/\tbar{X}]}
...
\infrule[L-Method-I]
  {{\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}[\tbar{E}]~\{~\tbar{M}~\}\in {\tt P}
   ...
   \wj{\Gamma}{{\tt C}[\tbar{A}]}
   \\
   \Gamma\vdash {\sf methods}({\tt D}[\tbar{E}[\tbar{A}/\tbar{X}]]) \ni {\tt m}[\tbar{C}](\tbar{x}:\tbar{G})\{{\tt l}\}:{\tt H}={\tt e}
   \andalso
   {\tt m}\not\in\tbar{M}}
  {\vdash {\sf methods}({\tt C}[\tbar{A}]) \ni {\tt m}[\tbar{C}](\tbar{x}:\tbar{G})\{{\tt l}\}:{\tt H}={\tt e}}
