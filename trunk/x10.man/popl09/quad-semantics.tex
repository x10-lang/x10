...
\newcommand\wjj[3]{{#1} \vdash {\sf type}({#2}),{\sf type}({#3})}
\newcommand\tj[3]{{#1} \vdash {#2} \ty {#3}}
\newcommand\stj[3]{{#1} \vdash {#2} \subtype {#3}}
\newcommand\ttj[2]{{#1} \vdash {\sf term}({#2})}
...
${\sf inv}({\tt T})=\wedge\{{\tt k}~s.t~\exists {\tt C}[\tbar{A}],{\tt T}\subtype{\tt C}[\tbar{A}], {\tt class}~{\tt C}[\tbar{X}\cdot\tbar{Y}](\tbar{f}:\tbar{F})\{{\tt l}\}~{\tt extends}~{\tt D}[\tbar{X}]~\{~\tbar{M}~\}\in {\tt P}, {\tt k}={\tt l}[\tbar{A}/\tbar{X}\cdot\tbar{Y}]\}$
...
\infrule[OK-Method]
  {{\tt class}~{\tt C}[\tbar{X}\cdot\tbar{Y}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}[\tbar{X}]~\{~\tbar{M}~\}\in {\tt P} \andalso
    ...
    \cj{\tbar{X}\cdot\tbar{Y}\cdot\tbar{Z}:\type,\this:{\tt C}[\tbar{X}\cdot\tbar{Y}],\tbar{x}:\tbar{G}}{\tt l}\andalso
...
\infrule[OK-Class]
  {\wjj{\tbar{X}\cdot\tbar{Y}:\type}{\tt C[\tbar{X}\cdot\tbar{Y}]}{\tbar{F}}\andalso
  \cj{\tbar{X}\cdot\tbar{Y}:\type,\tbar{x}:\tbar{F}}{{\tt k}[\tbar{x}/\this.\tbar{f}]} \andalso 
  \tbar{M}~{\rm OK~in}~{\tt C}[\tbar{X}\cdot\tbar{Y}]\andalso 
    \tbar{x}~\rm fresh}
...
\quad\typicallabel{XXXXXX}
\infrule[W-Class]
  {{\tt class}~{\tt C}[\tbar{X}\cdot\tbar{Y}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}[\tbar{X}]~\{~\tbar{M}~\} \in {\tt P} \andalso \wjj{\Gamma}{{\tt D}[\tbar{A}]}{\tbar{B}}}
...
\infrule[S-Class]
  {{\tt class}~{\tt C}[\tbar{X}\cdot\tbar{Y}](\tbar{f}:\tbar{G})\{{\tt k}\}~{\tt extends}~{\tt D}[\tbar{X}]~\{~\tbar{M}~\}\in {\tt P}\andalso
  \wj{\Gamma}{{\tt C}[\tbar{A}\cdot\tbar{B}]}}
