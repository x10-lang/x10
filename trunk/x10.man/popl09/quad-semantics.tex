...
\item Progress. \FXGD{} only differs from \FXZ{} in that it
admits a new class of expressions: {\tt C}\{{\tt c}\}. But these
are also values; therefore, the proof of progress is essentially
unchanged.
