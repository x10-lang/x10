...
\centering
\begin{tabular}{r@{\quad}rcl}
  (Constraint) & {\tt c} &{::=}& ${\tt X}~\underline{\has}~{\tt m}[\tbar{Y}](\tbar{x}\ty\tbar{G})\{{\tt c}\}\ty{\tt H}$ \\
\end{tabular}
\end{minipage}%
...
\quad\typicallabel{XXXXXX}
\infrule[W-Bound]
	{\wj{\Gamma}{\tt X} \andalso \wj{\Gamma}{\tt I}}
	{\wj{\Gamma}{{\tt X}~\underline\has~{\tt I}}}


\infrule
  {\methods({\tt C}[\tbar{A}])\ni\minst{Y}{x}{G}{c}{H}{e}}
  {\vdash{\tt C}[\tbar{A}]~\underline\has~{\tt m}[\tbar{Y}](\tbar{x}\ty\tbar{G})\{{\tt c}\}\ty{\tt H}}

\infrule
  {\vdash{\tt X}~\underline\has~{\tt m}[\tbar{Y}](\tbar{x}\ty\tbar{G})\{{\tt c}\}\ty{\tt H}}
  {}
...
\quad\typicallabel{XXXXXX}
\infrule[H-Bound]
	{\Gamma\vdash{\tt X}~\underline{\has}~{\tt f}\ty{\tt F} \andalso \theta={\tt x}/\this}
	{\Gamma,{\tt x}\ty{\tt X}\vdash {\tt x}~\has~{\tt f}\ty{\tt F}\theta}

\infrule[H-Bound]
	{\Gamma\vdash{\tt X}~\underline{\has}~{\tt I}
         \andalso
         \Gamma,{\tt x}\ty{\tt G}\vdash {\tt x}~\has~{\tt I}}
	{\Gamma,{\tt x}\ty{\tt X}\vdash {\tt x}~\has~{\tt I}}
\end{minipage}%
