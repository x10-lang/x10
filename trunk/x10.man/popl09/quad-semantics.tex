...
\infrule[T-Invk]
	{\Gamma\vdash {\tt e}\ty{\tt T},\tbar{a}\ty\tbar{U} \andalso
	  ...
	  \tbar{z}~{\rm fresh} \andalso
	  \theta=\tbar{z}/\tbar{y} \andalso
	  \Gamma,{\tt x}\ty{\tt T},\tbar{z}\ty\tbar{U}\vdash {\tt c}\theta,\tbar{z}\subtype\tbar{G}\theta}
	{\Gamma\vdash {\tt e}.{\tt m}[\tbar{A}](\tbar{a})\ty\extyty{\tt x}{\tt T}{\tbar{z}}{\tbar{U}}{\tt H}\theta}
...
\infrule[OK-Method]
  {\cdecl \andalso
    \wj{\tbar{X}\ty*,{\tt c},\this\ty{\tt C}[\tbar{X}],\tbar{Y}\ty*,\tbar{x}\ty\tbar{G},{\tt d}}{{\tt d},\tbar{G},{\tt H}} \\
    \tbar{X}\ty*,{\tt c},\this\ty{\tt C}[\tbar{X}],\tbar{Y}\ty*,\tbar{x}\ty\tbar{G},{\tt d}\vdash {\tt e}\ty{\tt E} \andalso
    {\tt y}~{\rm fresh} \andalso
    \tbar{X}\ty*,{\tt c},\this\ty{\tt C}[\tbar{X}],\tbar{Y}\ty*,\tbar{x}\ty\tbar{G},{\tt d},{\tt y}\ty{\tt E}\vdash {\tt y}\subtype {\tt H}}
  {\vdash\mdecl{Y}{x}{G}{d}{H}{e}~{\rm OK~in}~{\tt C}[\tbar{X}]}
