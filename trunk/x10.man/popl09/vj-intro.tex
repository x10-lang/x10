...
\subtype \Xcd{T}: a valuation (mapping from variables to types) realizes
...
{\footnotesize 
\Xcd{Array\{self.T <: Numeric, self.r.rank==2\}}
}
...
{\footnotesize
\Xcd{Array\{self.T==List\{self.length==N\},self.r.rank==N\}}
}
