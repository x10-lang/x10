...
The framework is parametrized on the specific constraint system
...
PolyJ~\cite{java-popl97} also uses structural constraints to bound type
parameters.
...
and extended for parametrized type systems by Igarashi and
