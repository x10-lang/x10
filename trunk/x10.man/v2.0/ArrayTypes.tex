...
\xcd"ValArray" can be a struct, class or function.}
}
...
\begin{xten}
package x10.lang;
public class ValRail[T](length: Int) extends (Int)=>T, Iterable[T] { }
public class Rail[T](length: Int) extends (Int)=>T, Settable[Int,T], Iterable[T] { }
\end{xten}
