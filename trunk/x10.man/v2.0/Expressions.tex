...
\bard{This section need serious whomping.  The Java mention needs to go.  The
rules for coercions are given in \Sref{effects-of-explicit-numeric-coercions}.
If the \xcd`Type` has a constraint, the constraint will be checked at runtime. 
