...
\label{body-type}
If
$$\Gamma, {\tt z}_{0:n}: {\tt T}_{0:n} \vdash {\tt z}_0\ \has\ {\tt m}({\tt z}_{1:n} \ty {\tt U}_{1:n})\{{\tt c}\}: {\tt S} = {\tt e},$$
and 
...
From
$\Gamma, {\tt z}_{0:n}: {\tt T}_{0:n} \vdash {\tt z}_0\ \has\ {\tt m}({\tt z}_{1:n} \ty {\tt U}_{1:n})\{{\tt c}\}: {\tt S} = {\tt e}$,
it is easy to show that for some {\tt C} such that $\Gamma \vdash {\tt T}_0 \subtype {\tt C}$,
${\tt def}\ {\tt m}(\tbar{z}:\tbar{U}[\this/{\tt z}_0])\{{\tt c[\this/{\tt z}_0]}\}:{\tt S}[\this/{\tt z}_0] = {\tt e} \in P$.

By \rn{Method OK},
$\this:{\tt C}\vdash {\tt c}:{\tt o}$
and
$\this:{\tt C},\tbar{z}:\tbar{U}[\this/{\tt z}_0],{\tt c}[\this/{\tt z}_0] \vdash {\tt S}[\this/{\tt z}_0] \ \type, \tbar{U}[\this/{\tt z}_0] \ \type, {\tt e}:{\tt V}, {\tt V} \subtype {\tt S}[\this/{\tt z}_0]$.
}
