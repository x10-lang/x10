...
or existentially quantified) ``index'' variables have to be
introduced. For instance the typing of the {\tt app} operation on
...
the constraint solver {e.g.{} {\tt bool}, {\tt int}, {\tt nat}) to
...
equality on object references.  (As we have seen permitting arbitary
