...
\authorinfo{Vijay Saraswat \and Nathaniel Nystrom \and \dots}
...
\newcommand\starderives{\stepsmany}
    ...
    \infrule[
  \rname{\tt\sc (R-Cast-Null)}]{}{\tt (nullable\ T)\; null \derives null}
