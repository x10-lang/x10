...
\conferenceinfo{OOSPLA'08}
               {Oct. XX--XX, 2008, Nashville, Tennessee, USA.}
\copyrightyear{2008}
...
\category{D.3.3}{Language Constructs and Features}{Classes and objects, XXX}
\terms{Languages}
\keywords{Object-oriented programming languages, dependent types}
\fi
