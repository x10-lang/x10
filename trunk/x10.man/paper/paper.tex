...
\lstnewenvironment{displayxten}
  {\footnotesize\lstset{language=X10,basicstyle=\tt,tabsize=4,columns=fullflexible,captionpos=b,xleftmargin=1em,xrightmargin=1em}}
  {}
\lstnewenvironment{xten}
  {\footnotesize\lstset{language=X10,basicstyle=\tt,tabsize=4,columns=fullflexible,captionpos=b}}
  {}
\newcommand\inputxten[1]{\footnotesize\lstinputlisting[language=X10,basicstyle=\tt]{#1}}


%\newenvironment{displayxten}{\begin{xten}}{\end{xten}}


\newcommand{\xcd}[1]{{\lstinline[language=X10,basicstyle=\tt]{#1}}}
\newcommand{\tcd}[1]{{\tt{#1}}}
