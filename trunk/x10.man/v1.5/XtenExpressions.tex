...
If is a static error if a methods \grammarrule{WhereClause} is not satisfied by the caller.
...
is permissible at run time. Both the data type and place type of the
