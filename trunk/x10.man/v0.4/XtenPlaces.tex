...
\todo{Introduce {\cf placeSet}? Alternative is to define
distributions.places as a built-in unique distribution and use
distributions wherever sets of places are expected.}
