...
public class ByteBuffer {
    ...
    private InvalidClassFileException invalidUtf8(int offset) {
        return new InvalidClassFileException(offset, "Invalid Java Utf8 string.");
    }

    /**
     * @return the value of the Utf8 string at constant pool item i
     */
    private String getUtf8(int offset, int count) throws InvalidClassFileException {
    ...
    public String getUtf8ToDelimiter(int offset, String delims) throws InvalidClassFileException {
        int i = offset();
    ...
    public String getUtf8ToDelimiter(String delims) throws InvalidClassFileException {
    ...
    public void getAttributeOffsets(int[] offsets) throws InvalidClassFileException {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (payloadLen < 0) {
                throw new InvalidClassFileException(offset(), "negative attribute length: " + payloadLen);
            }
            skip(payloadLen);
        }
