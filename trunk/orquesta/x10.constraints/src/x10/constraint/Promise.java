...
public interface Promise extends Cloneable {
	 ...
	 * @throws Failure 
	 */
	Promise intern(C_Var[] vars, int index) throws Failure;
	 ...
	 * @throws Failure 
	 */
	Promise intern(C_Var[] vars, int index, Promise last) throws Failure;
	 ...
	 * @throws Failure 
	 */
	Promise lookup(C_Var[] vars, int index) throws Failure;

	Promise lookup(C_Name s) throws Failure;

	Promise lookup() throws Failure;
	 ...
	 */
	void addIn(C_Name s, Promise child) throws Failure;
	 ...
	 * @param result
	 */
	void dump(List<C_Term> result, C_Term prefix);

	void dump(List<C_Term> result, C_Term prefix, C_Var newSelf);
