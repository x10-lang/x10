...
public class ClosureType_c extends Type_c implements ClosureType {
    ...
    public ClosureType_c(TypeSystem ts, Position pos, Ref<? extends Type> returnType, List<Ref<? extends Type>> typeParams, List<Ref<? extends Type>> argTypes, Ref<? extends XConstraint> whereClause, List<Ref<? extends Type>> throwTypes) {
	this(ts, pos);
