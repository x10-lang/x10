...
public class X10CAstPrinter extends CAstPrinter {
	...
	switch(kind) {
	    ...
	    case X10CastNode.ASYNC: return "ASYNC_INVOKE";
	    ...
	    case X10CastNode.ITER_INIT: return "REGION_INIT";
	    case X10CastNode.ITER_HASNEXT: return "REGION_HASNEXT";
	    case X10CastNode.ITER_NEXT: return "REGION_NEXT";
	    case X10CastNode.PLACE_OF_POINT: return "PLACE_OF_POINT";
	    case X10CastNode.DIST: return "ARRAY_DISTRIBUTION";
