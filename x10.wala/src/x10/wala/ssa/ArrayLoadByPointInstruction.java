...
public class ArrayLoadByPointInstruction extends ArrayReferenceByPointInstruction {
    private final int result;

    public ArrayLoadByPointInstruction(int result, int arrayRef, int pointIndex, TypeReference declaredType) {
	...
	return ((AstX10InstructionFactory)insts).ArrayLoadByPoint(
