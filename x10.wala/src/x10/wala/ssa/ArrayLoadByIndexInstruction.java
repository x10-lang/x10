...
public class ArrayLoadByIndexInstruction extends ArrayReferenceByIndexInstruction {
    private final int result;

    public ArrayLoadByIndexInstruction(int result, int arrayRef, int dims[], TypeReference declaredType) {
	...
	return ((AstX10InstructionFactory)insts).ArrayLoadByIndex(
