...
public class PolyglotClassLoaderFactoryImpl extends ClassLoaderFactoryImpl {
  ...
  public PolyglotClassLoaderFactoryImpl(SetOfClasses exclusions, IRTranslatorExtension javaExtInfo) {
    super(exclusions);
