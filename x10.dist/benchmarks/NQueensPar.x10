        ...
        def searchOne(k:Int) {
            if (safe(k)) {
                if (fixed==(N-1)) {
                    ...
                    /*directly access other class's field?
                     */
                    atomic /*atomic automatically protected*/ NQueensPar.this.nSolutions++;
                } else {
                    q(fixed++) = k;
                    search();
                    fixed--;
