...
eval tar -cvzf "$cdir/$tarfile" --exclude=.gitignore INSTALL.txt README.txt RELEASE.NOTES.txt bin/{x10,runx10,x10c,x10cj,x10c++,X10Launcher,x10doc} epl-v10.html etc include stdlib lib/*.jar lib/logging.properties lib/${PLAT_LIBPAT} samples
