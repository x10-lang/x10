 ...
 *   $ X10_RESILIENT_MODE=1 X10_NPLACES=4 run.sh x10 ResilientSimpleHeatTransfer [size]
 * For Native X10:
 *   $ x10c++ ResilientSimpleHeatTransfer.x10 -o ResilientSimpleHeatTransfer
 *   $ X10_RESILIENT_MODE=1 X10_NPLACES=4 run.sh runx10 ResilientSimpleHeatTransfer [size]
 */
