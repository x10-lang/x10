...
public class RefactoringPosition {
	...
	/**
	 * Determines whether object equality for this RefactoringPosition
	 * object is determined by reference or by standard/contains equality.
	 * Setting checkMode true allows multiple RefactoringPositions to be
	 * put into a HashMap, even if they represent the same source position.
	 *
	 */
	...
	/**
	 * Turns on the contains mode of checking for RefactoringPosition
	 * objects. Does not affect objects in checkMode.
	 *
	 */
	...
	/**
	 * Turns off the contains mode of checking for RefactoringPosition
	 * objects. Does not affect objects in checkMode.
	 *
	 */
	...
	/**
	 * The equals method for a RefactoringPosition has three behaviors,
	 * depending on the mode of checking:
	 * 1. object reference equality [checkMode]
	 * 2. containment (this contains compared object) [containsMode]
	 * 3. "loose" source position equality 
	 *    (same lines, but possibly different column positions) [standard] 
	 */
	...
	/**
	 * Returns true if "this" position contains the position in the
	 * argument. Containment is not well defined for positions that
	 * span multiple lines.
	 * 
	 * @param rp
	 * @return
