...
public final /*value*/ class String implements (nat) => Char {
    // TODO: constructors
    ...
    @Native("java", "java.lang.String.format(#1, new Object() { final Object[] unbox(Object[] a) { Object[] b = new Object[a.length]; for (int i = 0; i < a.length; i++) { if (a[i] instanceof x10.lang.Nullable) b[i] = ((x10.lang.Nullable) a[i]).value(); else b[i] = a[i]; } return b; } }.unbox(#2.getBoxedArray()))")
