...
/**
 * The InstanceOfParent instruction class.
 *
 * The header comment for {@link Instruction} contains
 * an explanation of the role of these interior class in 
 * opt compiler's IR.
 */
public abstract class InstanceOfParent extends Instruction
  ...
  /**
    * Constructor for InstanceOfParent.
    *
    * @param result
    * @param type
    * @param ref
    * @param guard
    */
  InstanceOfParent (Operand result, TypeOperand type, Operand ref, Operand guard) {
    this.result = result;
    this.type = type;
    this.ref = ref;
    this.guard = guard;
