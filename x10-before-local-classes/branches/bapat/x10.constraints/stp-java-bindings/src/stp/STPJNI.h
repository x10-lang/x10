...
JNIEXPORT jlong JNICALL Java_stp_STPJNI_vc_1bvConstExprFromInt (JNIEnv *env, jclass, jlong, jint, jlong);
JNIEXPORT jlong JNICALL Java_stp_STPJNI_vc_1bv32ConstExprFromInt (JNIEnv *env, jclass, jlong, jlong);
