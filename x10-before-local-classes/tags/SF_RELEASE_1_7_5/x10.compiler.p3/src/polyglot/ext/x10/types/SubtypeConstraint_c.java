...
public class SubtypeConstraint_c implements SubtypeConstraint {
     ...
     * (non-Javadoc)
     * 
     * @see polyglot.ext.x10.types.SubtypeConstraint#isEqualityConstraint()
     */
     ...
     * (non-Javadoc)
     * 
     * @see polyglot.ext.x10.types.SubtypeConstraint#subtype()
     */
    public Type subtype() {
        return subtype;
    }
     ...
     * (non-Javadoc)
     * 
     * @see polyglot.ext.x10.types.SubtypeConstraint#supertype()
     */
