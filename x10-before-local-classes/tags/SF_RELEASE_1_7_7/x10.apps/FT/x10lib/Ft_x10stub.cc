...
void Ft::initialize (Array<double, 1>* Array, x10_int_t size, x10_int_t offset, x10_int_t PID)
{
  Ft_initialize (BASE_PTR(Array), NULL, size, offset, PID);
}

void Ft::initializeC (x10_int_t numPLACE, x10_int_t nx, x10_int_t ny, x10_int_t nz, x10_int_t offset, x10_int_t cpad_cols)
{
  Ft_initializeC (numPLACE, nx, ny, nz, offset, cpad_cols);
}
void  Ft::computeInitialConditions (Array<double, 1>* Array, x10_int_t PID)
{
  Ft_computeInitialConditions (BASE_PTR(Array), NULL, PID);
}
void  Ft::init_exp (Array<double, 1>* Array, double alpha, x10_int_t PID)
{
  Ft_init_exp (BASE_PTR(Array), NULL, alpha, PID);
}

void  Ft::set_orientation (x10_int_t orientation)
{
  Ft_set_orientation (orientation);
}
void  Ft::parabolic2 (Array<double, 1>* out, Array<double, 1>* in, Array<double, 1>* ex, x10_int_t t, double alpha)
{
  Ft_parabolic2 (BASE_PTR(out), NULL, BASE_PTR(in), NULL, BASE_PTR(ex), NULL, t, alpha);
}
void  Ft::FFTInit (x10_int_t comm, Array<double, 1>* local2d, Array<double, 1>* local1d, x10_int_t PID)
{
...
void  Ft::FT_1DFFT (x10_int_t ft_comm, Array<double, 1>* in, Array<double, 1>* out, x10_int_t offset, x10_int_t dir, x10_int_t orientation, x10_int_t PID)
{
  Ft_FT_1DFFT (ft_comm, BASE_PTR(in), NULL, BASE_PTR(out), NULL, offset, dir, orientation, PID);
}
void  Ft::FFT2DLocalCols (Array<double, 1>* local2d, x10_int_t ComplexOffset, x10_int_t dir, x10_int_t orientation, x10_int_t PID)
{
  Ft_FFT2DLocalCols (BASE_PTR(local2d), NULL, ComplexOffset, dir, orientation, PID);
}
void  Ft::FFT2DLocalRow (Array<double, 1>* local2d, x10_int_t ComplexOffset, x10_int_t dir, x10_int_t orientation, x10_int_t PID)
{
  Ft_FFT2DLocalRow (BASE_PTR(local2d), NULL, ComplexOffset, dir, orientation, PID);
}
x10_int_t  Ft::origindexmap (x10_int_t x, x10_int_t y, x10_int_t z)
{
  Ft_origindexmap (x, y, z);
}

x10_int_t  Ft::getowner (x10_int_t x, x10_int_t y, x10_int_t z)
{
  Ft_getowner (x, y, z);
}
