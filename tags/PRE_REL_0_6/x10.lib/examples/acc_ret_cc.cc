 ...
 * $Id: acc_ret_cc.cc,v 1.1 2007-06-27 14:48:33 srkodali Exp $
 * This file is part of X10 Runtime System.
 */

/** Example Program using the x10lib::Put() api call.
 ...
 ** from src to tgt with a x10lib::NbPut() [non-blocking] call.
 ** The ints are then manipulated and sent back to the src
 ** with another x10lib::Put() [blocking] call.
