class Axeqb {
    public static void main(String[] args) {
        ...
        Axeqb solver = new Axeqb(N, debug);
        solver.setup();
        ...
        if (debug) solver.print();
        if (!Axeqb.computeYDirectly) solver.LyeqPb();
        if (debug) {
            solver.print();
            solver.checkLy();
        }
        ...
        finish {
            if (true == false) {
                if (true == false) {
                    ...
                    async(A.distribution[0,0]) {
                        A[0,0] = 11; A[0,1] = 3; A[0,2] = 8;
                    }
                    async(A.distribution[1,0]) {
                        A[1,0] = 7; A[1,1] = 6; A[1,2] = 3;
                    }
                    async(A.distribution[2,0]) {
                        A[2,0] = 5; A[2,1] = 5; A[2,2] = 1;
                    }
                }
                ...
                async(A.distribution[0,0]) {
                    A[0,0] = 5; A[0,1] = 3; A[0,2] = 11;
                }
                async(A.distribution[1,0]) {
                    A[1,0] = 7; A[1,1] = 2; A[1,2] = 6;
                }
                async(A.distribution[2,0]) {
                    A[2,0] = 11; A[2,1] = 5; A[2,2] = 1;
                }
            } else {
                int init = 1325;
