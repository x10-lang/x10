...
Java_JacobiExtern_JacobiExtern_1computeError(JNIEnv *env, jobject obj, jlong dbl, jlong dbl_x10DeScRiPtOr, jlong temp, jlong temp_x10DeScRiPtOr){
   return JacobiExtern_computeError( (double *)dbl, (int*)dbl_x10DeScRiPtOr, (double *) temp, (int *)temp_x10DeScRiPtOr);
}
