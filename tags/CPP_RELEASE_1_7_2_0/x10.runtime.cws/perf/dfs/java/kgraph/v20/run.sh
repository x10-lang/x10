...
#
# $Id: run.sh,v 1.1 2008-02-22 12:27:24 srkodali Exp $
#
# Interactive script for benchmarking dfs.java.kgraph programs.
#

TOP=../../../..
prog_name=dfs.java.kgraph
