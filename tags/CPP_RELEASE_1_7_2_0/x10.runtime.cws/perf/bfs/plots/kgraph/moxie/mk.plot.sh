...
#
# $Id: mk.plot.sh,v 1.1 2008-02-25 11:04:17 srkodali Exp $
#
...
printf "set title \"BFS:KGraph [Moxie/250K]\"\n" >> $tmp_file
...
printf "set title \"BFS:KGraph [Moxie/1M]\"\n" >> $tmp_file
...
printf "set title \"BFS:KGraph [Moxie/4M]\"\n" >> $tmp_file
...
printf "set title \"BFS:KGraph [Moxie/9M]\"\n" >> $tmp_file
