...
public class X10NodeFactory_c extends NodeFactory_c implements X10NodeFactory {
	...
	protected X10NodeFactory_c(ExtensionInfo extInfo, DelFactory delFact) {
		this(extInfo, new X10ExtFactory_c(), delFact);
	}

	public X10NodeFactory_c(ExtensionInfo extInfo) {
		this(extInfo, new X10DelFactory_c());
	}
			...
			List interfaces, ClassBody body)
	{
		...
		if (ci != null) {
			...
			tci =	(X10TypeNode) AmbTypeNode(Position.COMPILER_GENERATED, name);
...
//	 Wrap the body in a block to facilitate code transformations
	...
	*/
	...
	public Tuple Tuple(Position pos, Receiver p, Receiver r, List a) {
