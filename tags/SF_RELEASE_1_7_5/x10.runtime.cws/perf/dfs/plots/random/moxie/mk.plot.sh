...
#
# $Id: mk.plot.sh,v 1.2 2008-02-25 16:38:28 srkodali Exp $
#
...
printf "set title \"DFS:Random [Moxie/1M]\"\n" >> $tmp_file
...
printf "set title \"DFS:Random [Moxie/4M]\"\n" >> $tmp_file
...
printf "set title \"DFS:Random [Moxie/9M]\"\n" >> $tmp_file
