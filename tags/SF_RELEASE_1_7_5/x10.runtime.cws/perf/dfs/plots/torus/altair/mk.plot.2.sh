...
printf "\n" >> $tmp_file
printf "\"${c_tbl}\" index 1 using 3:5 title \"C\" with linespoints lw 2 pt 8, \\" >> $tmp_file
printf "\n" >> $tmp_file
printf "\"${cilk_tbl}\" index 1 using 3:5 title \"Cilk\" with linespoints lw 2 pt 2" >> $tmp_file
printf "\n" >> $tmp_file
