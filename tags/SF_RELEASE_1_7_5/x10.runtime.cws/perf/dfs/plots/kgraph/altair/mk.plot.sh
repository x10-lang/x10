...
#
# $Id: mk.plot.sh,v 1.2 2008-02-25 16:22:33 srkodali Exp $
#
...
printf "set title \"DFS:KGraph [Altair/1M]\"\n" >> $tmp_file
...
printf "set title \"DFS:KGraph [Altair/4M]\"\n" >> $tmp_file
...
printf "set title \"DFS:KGraph [Altair/9M]\"\n" >> $tmp_file
