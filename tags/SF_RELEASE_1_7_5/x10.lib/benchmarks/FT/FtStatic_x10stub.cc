...
void FtStatic::initialize (LocalArray<double, 1>* Array, x10_int_t size, x10_int_t offset, x10_int_t PID)
{
...
void  FtStatic::computeInitialConditions (LocalArray<double, 1>* Array, x10_int_t PID)
{
  Ft_computeInitialConditions (BASE_PTR(Array), NULL, PID);
}
void  FtStatic::init_exp (LocalArray<double, 1>* Array, double alpha, x10_int_t PID)
{
...
void  FtStatic::parabolic2 (LocalArray<double, 1>* out, LocalArray<double, 1>* in, LocalArray<double, 1>* ex, x10_int_t t, double alpha)
{
  Ft_parabolic2 (BASE_PTR(out), NULL, BASE_PTR(in), NULL, BASE_PTR(ex), NULL, t, alpha);
}
void  FtStatic::FFTInit (x10_int_t comm, LocalArray<double, 1>* local2d, LocalArray<double, 1>* local1d, x10_int_t PID)
{
...
void  FtStatic::FT_1DFFT (x10_int_t ft_comm, LocalArray<double, 1>* in, LocalArray<double, 1>* out, x10_int_t offset, x10_int_t dir, x10_int_t orientation, x10_int_t PID)
{
  Ft_FT_1DFFT (ft_comm, BASE_PTR(in), NULL, BASE_PTR(out), NULL, offset, dir, orientation, PID);
}
void  FtStatic::FFT2DLocalCols (LocalArray<double, 1>* local2d, x10_int_t ComplexOffset, x10_int_t dir, x10_int_t orientation, x10_int_t PID)
{
  Ft_FFT2DLocalCols (BASE_PTR(local2d), NULL, ComplexOffset, dir, orientation, PID);
}
void  FtStatic::FFT2DLocalRow (LocalArray<double, 1>* local2d, x10_int_t ComplexOffset, x10_int_t dir, x10_int_t orientation, x10_int_t PID)
{
