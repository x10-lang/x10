...
public class CvcSetConstraintSystem implements ConstraintSystem {

    X10TypeSystem typeSystem;
    
    public CvcSetConstraintSystem(X10TypeSystem xts) {
        this.typeSystem = xts;
    }

    public SimpleConstraint binding(C_Var v1, C_Var v2) {
        return new CvcSetConstraint_c(typeSystem, new C_BinaryTerm_c("==", v1, v2, typeSystem.Boolean()), this);
    }
    ...
    public SimpleConstraint constraintForTerm(C_Term t) throws SemanticException {
        ...
        SimpleConstraint oc = new CvcSetConstraint_c(typeSystem, t, this);
