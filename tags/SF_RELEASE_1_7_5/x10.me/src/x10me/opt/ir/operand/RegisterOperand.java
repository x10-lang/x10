 ...
 * @see Operand
 */
public final class RegisterOperand extends LocationOperand {
   ...
   * @param typ data type
   */
  public RegisterOperand(Register reg, Type typ) {
    setRegister(reg);
    setType(typ);
  }
   ...
   */
  public RegisterOperand(Register reg, Type typ, byte inFlags,
   ...
   *         is int-like as defined by {@link Type#isIntLikeType}
   ...
   *
   * @return <code>true</code> if the data type of <code>this</code>
   *         is a long as defined by {@link Type#isLongType}
   *         or <code>false</code> if it is not.
   */
  @Override
   ...
   *
   * @return <code>true</code> if the data type of <code>this</code>
   *         is a float as defined by {@link Type#isFloatType}
   *         or <code>false</code> if it is not.
   */
  @Override
   ...
   *
   * @return <code>true</code> if the data type of <code>this</code>
   *         is a double as defined by {@link Type#isDoubleType}
   *         or <code>false</code> if it is not.
   */
  @Override
   ...
   *
   * @return <code>true</code> if the data type of <code>this</code>
   *         is a reference as defined by {@link Type#isReferenceType}
   *         or <code>false</code> if it is not.
   */
  @Override
  ...
  public boolean isDefinitelyNull() {
    return type == KnownTypes.NULL_TYPE;
  }
  ...
  public String toString() {
    ...
    if (type != null) {
      if (type != KnownTypes.VALIDATION_TYPE) {
        s = s + "(" + type.getName();
        if (isExtant()) s += ",x";
  ...
  /**
   * Set the {@link Type} of the value represented by the operand.
   *
  ...
  /**
   * Set the {@link Type} of the value represented by the operand and
   * make the type precise.
   *
   * @param t the inferred data type of the contents of the register
   */
  public void setPreciseType(Type t) {
    type = t;
    flags |= PRECISE_TYPE;
  }
