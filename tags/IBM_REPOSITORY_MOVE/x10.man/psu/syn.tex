...
BNF.  The syntax for the entire language is given here.
...
\meta{Datum} generates the standard external representations for
Scheme datatypes.  The \ide{read} procedure parses \meta{datum}, but
see~\ref{read} for restrictions.  Note that any string that parses as
an \meta{ex\-pres\-sion} will also parse as a \meta{datum}.
\label{datum}
...
\section{Programs and definitions}
