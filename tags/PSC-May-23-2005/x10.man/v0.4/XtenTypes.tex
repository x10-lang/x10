...
java.lang.System}. \Xten{} programs should not use the {\cf
synchronized} method on such objects, or create new {\cf Thread}s, or
invoke any {\tt wait/notify} methods on such objects.

\paragraph{Future extensions.} 
The above represents an {\em ad hoc} integration of \java{} libraries
into \Xten{}. In the future a more principled and robust scheme will
be worked out.
