...
$(SOCKETS_TGZ).phony:
	-$(WGET) -N  "http://dist.codehaus.org/x10/binaryReleases/2.0.1/$(SOCKETS_TGZ)"
...
$(LAPI_TGZ).phony:
	-$(WGET) -N  "http://dist.codehaus.org/x10/binaryReleases/2.0.1/$(LAPI_TGZ)"
...
$(BGP_TGZ).phony:
	-$(WGET) -N  "http://dist.codehaus.org/x10/binaryReleases/2.0.1/$(BGP_TGZ)"
