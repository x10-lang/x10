...
extern int FtStatic_origindexmap(signed int x, signed int y, signed int z){
...
extern int FtStatic_getowner(signed int x, signed int y, signed int z){
  return getowner(x, y, z);
}

extern void FtStatic_set_orientation(signed int orientation){
...
extern void  FtStatic_initializeC(signed int numPlace, signed int nx, signed int ny, signed int nz, 
...
extern void  FtStatic_initialize(double* Array_x10PoInTeR, int* Array_x10DeScRiPtOr, signed int size, signed int offset, signed int PID) {
  int MYTHREAD = PID;
...
void computeInitialConditions (ComplexPtr_t cp, int PID)
{
  /*--------------------------------------------------------------------
...
extern void FtStatic_computeInitialConditions (double* Array_x10PoInTeR, int* Array_x10DeScRiPtOr, signed int PID){
...
extern void FtStatic_init_exp (double* Array_x10PoInTeR, int* Array_x10DeScRiPtOr, double alpha, signed int PID ){
...
extern void FtStatic_parabolic2 (double* out_x10PoInTeR, int* out_x10DeScRiPtOr, 
...
extern void FtStatic_FFTInit ( signed int comm, double* local2d_x10PoInTeR, int* local2d_x10DeScRiPtOr, 
...
extern void FtStatic_FFTWTest(void){
  int N =32;
  fftw_complex *in, *out;
...
extern void FtStatic_FT_1DFFT (signed int ft_comm, double* in_x10PoInTeR, int* in_x10DeScRiPtOr, 
...
extern void FtStatic_FFT2DLocalCols (double* local2d_x10PoInTeR, int* local2d_x10DeScRiPtOr, 
...
extern void FtStatic_FFT2DLocalRow (double* local2d_x10PoInTeR, int* local2d_x10DeScRiPtOr, 
			 signed int ComplexOffset, signed int dir, signed int orientation, signed int PID ){
