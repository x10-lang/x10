...
/**
 * Bundle class for all messages of "x10dt.ui.launch.java".
 * 
 * @author egeay
 */
...
public class Messages extends NLS {
  ...
  public static String MVMSP_SPDescription;

  public static String MVMSP_SPName;

  public static String PAHT_TabName;
  ...
  public static String XJLS_RMCreationError;
  ...
  public static String XLCD_NoLaunchersDir;

  public static String XLCD_NoLibDir;

  public static String XLCD_NoMainTypeName;

  public static String XLCD_NoResourceManager;

  public static String XLCD_NoX10Distrib;

  public static String XLCD_NoX10Script;

  public static String XLCD_OutputFolderNotDefined;
