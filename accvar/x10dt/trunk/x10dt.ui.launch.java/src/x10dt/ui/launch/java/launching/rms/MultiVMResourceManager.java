 ...
 * @author egeay
 */
public final class MultiVMResourceManager extends AbstractRuntimeResourceManager implements IResourceManager {
   ...
   */
  public MultiVMResourceManager(final String id, final IPUniverseControl universe, 
