...
public class ToggleOrientationAction extends Action {
	...
	public ToggleOrientationAction(ITypeHierarchyViewPart v, int orientation) {
		...
		if (orientation == ITypeHierarchyViewPart.VIEW_LAYOUT_HORIZONTAL) {
			...
			X10PluginImages.setLocalImageDescriptors(this, "th_horizontal.gif"); //$NON-NLS-1$
			...
			X10PluginImages.setLocalImageDescriptors(this, "th_vertical.gif"); //$NON-NLS-1$
			...
			X10PluginImages.setLocalImageDescriptors(this, "th_automatic.gif"); //$NON-NLS-1$
			...
			X10PluginImages.setLocalImageDescriptors(this, "th_single.gif"); //$NON-NLS-1$
		} else {
			Assert.isTrue(false);
		}
		fView= v;
