...
public class X10PluginImages {
	...
	private static final String T_OBJ= "objects"; 		//$NON-NLS-1$
	private static final String T_OVR= "overlay"; 		//$NON-NLS-1$
	private static final String T_WIZBAN= ""; 	//$NON-NLS-1$
	private static final String T_ELCL= ""; 	//$NON-NLS-1$
	private static final String T_DLCL= ""; 	//$NON-NLS-1$
	private static final String T_ETOOL= ""; 	//$NON-NLS-1$
	private static final String T_EVIEW= ""; //$NON-NLS-1$
	...
	public static final String IMG_DEFAULT_AST= NAME_PREFIX + "default_ast.gif"; //$NON-NLS-1$
	public static final String IMG_ALIAS= NAME_PREFIX + "alias.gif"; //$NON-NLS-1$
...
//    public static final ImageDescriptor DESC_DLCL_EXCLUSION_UNDO= createUnManaged(T_DLCL, "exclusion_filter_attrib_undo.gif"); //$NON-NLS-1$
	...
	public static final ImageDescriptor DESC_DEFAULT_AST = createManagedFromKey("", IMG_DEFAULT_AST);
    public static final ImageDescriptor DESC_ALIAS = createManagedFromKey("", IMG_ALIAS);
	...
	private static ImageDescriptor createManaged(String prefix, String name, String key) {
		...
		if (fgImageRegistry != null) {
			X10DTUIPlugin.getInstance().writeErrorMsg("Image registry already defined"); //$NON-NLS-1$
		}
		return result;
	}
	...
	private static ImageDescriptor create(String prefix, String name, boolean useMissingImageDescriptor) {
		...
		return createImageDescriptor(X10DTUIPlugin.getInstance().getBundle(), path, useMissingImageDescriptor);
	}
