...
public class X10ElementLabels {
	...
	/**
	 * Specifies to use the resolved information of a ITypeInfo, IMethodInfo or IFieldInfo. See {@link ITypeInfo#isResolved()}.
	 ...
	 */
	public final static String CONCAT_STRING= Messages.X10ElementLabels_concat_string;
	/**
	 * User-readable string for separating list items (e.g. ", ").
	 */
	public final static String COMMA_STRING= Messages.X10ElementLabels_comma_string;
	/**
	 * User-readable string for separating the return type (e.g. " : ").
	 */
	public final static String DECL_STRING= Messages.X10ElementLabels_declseparator_string;
//	/**
...
//	public final static String CATEGORY_SEPARATOR_STRING= JavaUIMessages.JavaElementLabels_category_separator_string;
	 ...
	 */
	public final static String DEFAULT_PACKAGE= Messages.X10ElementLabels_default_package;
...
//		new X10ElementLabelComposer(buf).appendClassFileLabel(classFile, flags);
//	}
//
//	/**
...
//		new X10ElementLabelComposer(result).appendClassFileLabel(classFile, flags);
//	}
...
//		new X10ElementLabelComposer(buf).appendCompilationUnitLabel(cu, flags);
//	}
//
//	/**
...
//		new X10ElementLabelComposer(result).appendCompilationUnitLabel(cu, flags);
//	}
...
//		new X10ElementLabelComposer(buf).appendPackageFragmentLabel(pack, flags);
//	}
//
//	/**
...
//		new X10ElementLabelComposer(result).appendPackageFragmentLabel(pack, flags);
//	}
//
//	/**
...
//		new X10ElementLabelComposer(buf).appendPackageFragmentRootLabel(root, flags);
//	}
//
//	/**
...
//		new X10ElementLabelComposer(result).appendPackageFragmentRootLabel(root, flags);
//	}
//
//	/**
...
//	 * @throws ModelException when resolving of the container failed
//	 */
//	public static String getContainerEntryLabel(IPath containerPath, IJavaProject project) throws ModelException {
