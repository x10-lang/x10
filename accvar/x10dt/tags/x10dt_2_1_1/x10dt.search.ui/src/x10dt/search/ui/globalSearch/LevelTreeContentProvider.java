...
public class LevelTreeContentProvider extends X10SearchContentProvider implements ITreeContentProvider {
	...
	public LevelTreeContentProvider(X10SearchResultPage page, int level) {
		super(page);
		fCurrentLevel= level;
