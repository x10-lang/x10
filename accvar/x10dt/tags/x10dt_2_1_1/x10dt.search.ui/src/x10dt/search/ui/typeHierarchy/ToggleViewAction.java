...
//			contextHelpId= IJavaHelpContextIds.SHOW_SUPERTYPES;
			...
			X10PluginImages.setLocalImageDescriptors(this, "super_co.gif"); //$NON-NLS-1$
...
//			contextHelpId= IJavaHelpContextIds.SHOW_SUBTYPES;
			...
			X10PluginImages.setLocalImageDescriptors(this, "sub_co.gif"); //$NON-NLS-1$
...
//			contextHelpId= IJavaHelpContextIds.SHOW_HIERARCHY;
			...
			X10PluginImages.setLocalImageDescriptors(this, "hierarchy_co.gif"); //$NON-NLS-1$
		} else {
			Assert.isTrue(false);
		}
