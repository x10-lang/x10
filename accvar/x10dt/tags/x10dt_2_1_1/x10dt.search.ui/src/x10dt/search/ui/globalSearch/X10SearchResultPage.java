...
public class X10SearchResultPage extends AbstractTextSearchViewPage implements IAdaptable {
	...
	private X10SearchEditorOpener fEditorOpener= new X10SearchEditorOpener();
	...
	public void showMatch(Match match, int offset, int length, boolean activate) throws PartInitException {
		...
		} else if (getInput() instanceof X10SearchResult) {
			X10SearchResult result= (X10SearchResult) getInput();
