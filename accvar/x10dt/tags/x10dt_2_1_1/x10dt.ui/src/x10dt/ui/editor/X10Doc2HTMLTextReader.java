 ...
 * Adapted from org.eclipse.jdt.internal.ui.text.javadoc.JavaDoc2HTMLTextReader
 */
public class X10Doc2HTMLTextReader extends SubstitutionTextReader {
	...
	public X10Doc2HTMLTextReader(Reader reader) {
		super(reader);
	...
	public void print(StringBuffer buffer, String tag, List elements, boolean firstword) {
		if ( !elements.isEmpty()) {
	...
	public void print(StringBuffer buffer, String tag, String content) {
		if  (content != null) {
			buffer.append("<dt>"); //$NON-NLS-1$
			buffer.append(tag);
			buffer.append("</dt>"); //$NON-NLS-1$
	...
	public String printSimpleTag() {
		StringBuffer buffer= new StringBuffer();
		buffer.append("<dl>"); //$NON-NLS-1$
		print(buffer, X10DocMessages.X10Doc2HTMLTextReader_see_section, fSees, false);
		print(buffer, X10DocMessages.X10Doc2HTMLTextReader_parameters_section, fParameters, true);
		print(buffer, X10DocMessages.X10Doc2HTMLTextReader_returns_section, fReturn);
		print(buffer, X10DocMessages.X10Doc2HTMLTextReader_throws_section, fExceptions, false);
		print(buffer, X10DocMessages.X10Doc2HTMLTextReader_author_section, fAuthors, false);
		print(buffer, X10DocMessages.X10Doc2HTMLTextReader_since_section, fSince, false);
		printRest(buffer);
		buffer.append("</dl>"); //$NON-NLS-1$
	...
	private String processSimpleTag() throws IOException {
		...
		while (c != -1) {
			...
			buffer.append((char) c);
			c= getTag(buffer);
			String tag= buffer.toString(); // e.g. "@param"
