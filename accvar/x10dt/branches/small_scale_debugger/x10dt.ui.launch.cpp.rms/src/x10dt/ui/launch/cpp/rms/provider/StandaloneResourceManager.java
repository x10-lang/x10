 ...
 * @author egeay
 */
public final class StandaloneResourceManager extends AbstractRuntimeResourceManager implements IResourceManager {
   ...
   */
  public StandaloneResourceManager(final String id, final IPUniverseControl universe, 
