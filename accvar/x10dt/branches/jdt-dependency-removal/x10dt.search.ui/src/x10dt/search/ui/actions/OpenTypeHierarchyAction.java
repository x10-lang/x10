...
import x10dt.search.ui.typeHierarchy.SelectionConverter;
...
//			return;
	...
	private static IStatus compileCandidates(List result, ITypeInfo elem) {
		IStatus ok= new Status(IStatus.OK, UISearchPlugin.PLUGIN_ID, 0, "", null); //$NON-NLS-1$
//		try {
...
//		}
	...
	private static IStatus createStatus(String message) {
		return new Status(IStatus.INFO, UISearchPlugin.PLUGIN_ID, IStatus.ERROR, message, null);
	}
}
