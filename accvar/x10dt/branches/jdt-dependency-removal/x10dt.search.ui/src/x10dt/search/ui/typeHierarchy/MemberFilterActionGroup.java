...
//			helpContext= IJavaHelpContextIds.FILTER_FIELDS_ACTION;
			...
			X10PluginImages.setLocalImageDescriptors(hideFields, "fields_co.gif"); //$NON-NLS-1$
...
//			helpContext= IJavaHelpContextIds.FILTER_STATIC_ACTION;
			...
			X10PluginImages.setLocalImageDescriptors(hideStatic, "static_co.gif"); //$NON-NLS-1$
...
//			helpContext= IJavaHelpContextIds.FILTER_PUBLIC_ACTION;
			...
			X10PluginImages.setLocalImageDescriptors(hideNonPublic, "public_co.gif"); //$NON-NLS-1$
...
//			helpContext= IJavaHelpContextIds.FILTER_LOCALTYPES_ACTION;
			...
			X10PluginImages.setLocalImageDescriptors(hideLocalTypes, "localtypes_co.gif"); //$NON-NLS-1$
