...
//				fInitiallySelectedType= (ITypeInfo)javaElement.getAncestor(ITypeInfo.TYPE);
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings settings= UISearchPlugin.getDefault().getDialogSettings().getSection(sectionName);
		if (settings == null)
			settings= UISearchPlugin.getDefault().getDialogSettings().addNewSection(sectionName);
