...
public class X10HeuristicScanner implements Symbols {
	...
	private static class NonWhitespace extends StopCondition {
		/*
		 * @see x10dt.ui.editor.X10HeuristicScanner.StopCondition#stop(char)
		 */
	...
	/**
	 * Stops upon a character that matches the given character list.
	 */
	private final class CharacterMatch extends StopCondition {
		...
		/*
		 * @see x10dt.ui.editor.X10HeuristicScanner.StopCondition#stop(char, int)
		 */
		public boolean stop(char ch, int position, boolean forward) {
