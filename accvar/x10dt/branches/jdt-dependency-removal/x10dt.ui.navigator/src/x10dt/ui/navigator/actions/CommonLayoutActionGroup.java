 ...
 *******************************************************************************/
package x10dt.ui.navigator.actions;
...
import x10dt.ui.navigator.internal.PackagesMessages;
...
//			}
	...
	private IAction[] createActions() {
		...
		X10PluginImages.setLocalImageDescriptors(fFlatLayoutAction, "flatLayout.gif"); //$NON-NLS-1$
		...
		X10PluginImages.setLocalImageDescriptors(fHierarchicalLayout, "hierarchicalLayout.gif"); //$NON-NLS-1$
