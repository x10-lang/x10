...
import x10dt.ui.navigator.actions.CommonLayoutActionGroup;
 ...
 * </ul>
 */
public class NavigatorViewActionProvider extends CommonActionProvider {

	private static final int HIERARCHICAL_LAYOUT= 0x1;

	private static final int FLAT_LAYOUT= 0x2;

	private static final String TAG_LAYOUT= "x10dt.ui.navigator.layout"; //$NON-NLS-1$
	...
	public void restoreState(IMemento memento) {
		...
		if (state == null) {
			IPreferenceStore store= UINavigatorPlugin.getDefault().getPreferenceStore();
