...
public : static  void initialize (LocalArray<double, 1>* Array, x10_int_t size, x10_int_t offset, x10_int_t PID); 
...
public: static  void computeInitialConditions (LocalArray<double, 1>* Array, x10_int_t PID);
public: static  void init_exp (LocalArray<double, 1>* Array, double alpha, x10_int_t PID);
public: static  void set_orientation (x10_int_t orientation);
public: static  void parabolic2 (LocalArray<double, 1>* out, LocalArray<double, 1>* in, LocalArray<double, 1>* ex, x10_int_t t, double alpha);
public: static  void FFTInit (x10_int_t comm, LocalArray<double, 1>* local2d, LocalArray<double, 1>* local1d, x10_int_t PID);
public: static  void FFTWTest();
public: static  void FT_1DFFT (x10_int_t ft_comm, LocalArray<double, 1>* in, LocalArray<double, 1>* out, x10_int_t offset, x10_int_t dir, x10_int_t orientation, x10_int_t PID);
public: static void FFT2DLocalCols (LocalArray<double, 1>* local2d, x10_int_t ComplexOffset, x10_int_t dir, x10_int_t orientation, x10_int_t PID);
public: static void FFT2DLocalRow (LocalArray<double, 1>* local2d, x10_int_t ComplexOffset, x10_int_t dir, x10_int_t orientation, x10_int_t PID);
