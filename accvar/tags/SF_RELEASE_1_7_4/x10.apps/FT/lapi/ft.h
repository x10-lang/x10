...
#define FFT_FWD 1
#define FFT_BWD 0
extern void FFTInit(int threads, int dims[3][3], int comm, ComplexPtr_t local2d, ComplexPtr_t local1d);
extern void FFTFinalize();
extern void FFT2DLocal(ComplexPtr_t inout, int dir, int orientation, int *dims);
extern void FFT2DLocalCols(ComplexPtr_t in, int dir, int orientation, int *dims);
extern void FFT2DLocalRow(ComplexPtr_t in, int dir, int orientation, int *dims);
extern void FFT2DLocalRows(int nrows, ComplexPtr_t inout, int dir, int orientation, int *dims);
extern void FFT1DLocalTranspose(ComplexPtr_t local1d, ComplexPtr_t local2d, int dir, int orient);
extern void FFT1DLocal(ComplexPtr_t local1d, ComplexPtr_t local2d, int dir, int orient);
extern void checksum_verify (int d1, int d2, int d3, int nt, double *real_sums, double *imag_sums);
extern const char *FFTName;

extern void init_exp(double*, double, int, int, int, int, int);
