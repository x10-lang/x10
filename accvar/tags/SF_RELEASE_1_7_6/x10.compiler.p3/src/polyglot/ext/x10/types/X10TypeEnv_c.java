...
public class X10TypeEnv_c extends TypeEnv_c implements X10TypeEnv {
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#consistent(x10.constraint.XConstraint)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#consistent(polyglot.types.Type)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#equalBounds(polyglot.types.Type)
     */
...
//            }
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#findAcceptableTypeDefs(polyglot.types.Type, polyglot.ext.x10.types.X10TypeSystem_c.TypeDefMatcher)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#typeEquals(polyglot.types.Type, polyglot.types.Type, java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#entails(x10.constraint.XConstraint, x10.constraint.XConstraint)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#hasSameClassDef(polyglot.types.Type, polyglot.types.Type)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#equivClause(polyglot.types.Type, polyglot.types.Type)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#entailsClause(polyglot.types.Type, polyglot.types.Type)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#typeBaseEquals(polyglot.types.Type, polyglot.types.Type)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#typeDeepBaseEquals(polyglot.types.Type, polyglot.types.Type)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#equalTypeParameters(java.util.List, java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#primitiveClausesConsistent(x10.constraint.XConstraint, x10.constraint.XConstraint)
     */
    ...
    /* (non-Javadoc)
     * @see polyglot.ext.x10.types.X10TypeEnv#clausesConsistent(x10.constraint.XConstraint, x10.constraint.XConstraint)
     */
