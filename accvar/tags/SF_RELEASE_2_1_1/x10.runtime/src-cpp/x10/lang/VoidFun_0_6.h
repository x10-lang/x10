...
namespace x10 {
    namespace lang {
        ...
        template<class P1, class P2, class P3, class P4, class P5, class P6> class VoidFun_0_6 : public x10aux::AnyFun {
            ...
            static void apply(x10aux::ref<x10::lang::Reference> recv, P1 arg1, P2 arg2, P3 arg3, P4 arg4, P5 arg5, P6 arg6) {
                return (recv.operator->()->*(x10aux::findITable<VoidFun_0_6<P1,P2,P3,P4,P5,P6> >(recv->_getITables())->apply))(arg1, arg2, arg3, arg4, arg5, arg6);
            }
