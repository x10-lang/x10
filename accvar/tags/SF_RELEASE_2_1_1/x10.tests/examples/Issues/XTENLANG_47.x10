...
class XTENLANG_47 extends x10Test {
	...
	public class CL(rank2:Int) {
		...
		private class It implements Iterator[C{self.rank==rank2}] {  // ShouldNotBeERR: Semantic Error: Cannot access field rank2 of XTENLANG_47.CL.It in class declaration header; the field may be a member of a superclass.
