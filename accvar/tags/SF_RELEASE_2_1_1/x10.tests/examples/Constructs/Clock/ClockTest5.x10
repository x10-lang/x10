...
public class ClockTest5 extends x10Test {
	...
	public def run(): boolean = {
		...
		/*Activity_1A*/async clocked(c) { m("1A", "(c)", 0); next; m("1A", "(c)", 1); next; }
		/*Activity_1B*/async clocked(c) { m("1B", "(c)", 0); next; m("1B", "(c)", 1); next; }
		/*Activity_2A*/async clocked(d) { m("2A", "(d)", 0); next; m("2A", "(d)", 1); next; }
		/*Activity_2B*/async clocked(d) { m("2B", "(d)", 0); next; m("2B", "(d)", 1); next; }
		/*Activity_3A*/async clocked(e) { m("3A", "(e)", 0); next; m("3A", "(e)", 1); next; }
		/*Activity_3B*/async clocked(e) { m("3B", "(e)", 0); next; m("3B", "(e)", 1); next; }
		/*Activity_4A*/async clocked(c, d) { m("4A", "(c, d)", 0); next; m("4A", "(c, d)", 1); next; }
		/*Activity_4B*/async clocked(c, d) { m("4B", "(c, d)", 0); next; m("4B", "(c, d)", 1); next; }
		/*Activity_5A*/async clocked(c, e) { m("5A", "(c, e)", 0); next; m("5A", "(c, e)", 1); next; }
		/*Activity_5B*/async clocked(c, e) { m("5B", "(c, e)", 0); next; m("5B", "(c, e)", 1); next; }
		/*Activity_6A*/async clocked(d, e) { m("6A", "(d, e)", 0); next; m("6A", "(d, e)", 1); next; }
		/*Activity_6B*/async clocked(d, e) { m("6B", "(d, e)", 0); next; m("6B", "(d, e)", 1); next; }
		/*Activity_7A*/async clocked(c, d, e) { m("7A", "(c, d, e)", 0); next; m("7A", "(c, d, e)", 1); next; }
		/*Activity_7B*/async clocked(c, d, e) { m("7B", "(c, d, e)", 0); next; m("7B", "(c, d, e)", 1); next; }
