...
blocked or resumed as the result of actions taken by any other
activity.
...
is blocked at a statement (such as the \xcd"finish" statement
...
%~~gen
% package Activities.For.The.Future;
% class FutureExample[T] {
% def useFuture(a:DistArray[T](1), pt:Point(1)) {
%~~vis
\begin{xten}
