...
//			System.out.println("Running " + plugin().getClass().getName());
	...
	public Expr checkField(Field f, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
	...
	public Expr checkLocal(Local l, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
	...
	public Expr checkCall(Call c, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
	...
	public Expr checkNew(New n, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
	...
	public X10Type binaryPromote(Binary b, TypeSystem ts, NodeFactory nf) throws SemanticException {
		return (X10Type) b.type();
	}
	
	public X10Type unaryPromote(Unary u, TypeSystem ts, NodeFactory nf) throws SemanticException {
		return (X10Type) u.type();
	}
	
	public Expr checkCast(X10Type castType, Expr e, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
	...
	public boolean checkCastCoercion(X10Type toType, X10Type fromType, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
		return true;
	}
	
	public Expr checkImplicitCoercion(X10Type toType, Expr e, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
		X10Type etype = (X10Type) e.type();
	...
	public boolean checkNumericCoercion(X10Type toType, Expr e, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
		return true;
	}
	
	public boolean checkImplicitCoercion(X10Type toType, X10Type fromType, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
		return true;
	}
	...
	public class CastRewriteVisitor extends ContextVisitor {
		...
		public Node leaveCall(Node parent, Node old, Node n, NodeVisitor v) throws SemanticException {
			if (n instanceof X10Cast) {
				return rewriteCast((X10Cast) n, (Context) context, (TypeSystem) ts, (NodeFactory) nf);
			}
			if (n instanceof X10Instanceof) {
				return rewriteInstanceof((X10Instanceof) n, (Context) context, (TypeSystem) ts, (NodeFactory) nf);
			}
			return n;
		}
	...
	protected Expr rewriteCast(X10Cast n, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
		return n;
	}
	
	protected Expr rewriteInstanceof(X10Instanceof e, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
		return e;
	}
	...
	protected Expr annotationCast(Expr e, Context context, TypeSystem ts, NodeFactory nf) throws SemanticException {
		return e;
	}
}
