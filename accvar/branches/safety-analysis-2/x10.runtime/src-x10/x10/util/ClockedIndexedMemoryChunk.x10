 ...
 */
public struct ClockedIndexedMemoryChunk[T] {
    ...
    /**
     * Operator that allows assignment of ClockedIndexedMemoryChunk elements by index.
     *
     * @param v The value to assign.
     * @param i The index of the element to be changed.
     * @return The new value.
     */
    public safe @Header @Inline def set(value:T, index:int) = (chunk(index) as ClockedVar[T]!).setClocked(value);
    ...
    */
    ...
    @NativeRep("c++", "x10::util::ClockedIndexedMemoryChunk__RawChunk<#1 >", "x10::util::ClockedIndexedMemoryChunk__RawChunk<#1 >", null)
    private static struct RawChunk[T] {
	@Native("java", "x10.core.RailFactory.<#2>makeVarRail(#3, #4)")
        @Native("c++", "x10::util::ClockedIndexedMemoryChunk__RawChunk<#1 >::allocate(#4, #5, #6, #7)")
