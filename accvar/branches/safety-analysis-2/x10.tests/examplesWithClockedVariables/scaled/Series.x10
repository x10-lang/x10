...
public class Series extends SeriesTest {

	private var size: int;

	public def JGFsetsize(var size: int): void = @ClockedM(SeriesTest.c) {
		this.size = size;
	}
	...
	public def JGFkernel(): void = @ ClockedM(SeriesTest.c) {
		Do();
	}

	public def JGFvalidate(): void = @ClockedM(SeriesTest.c) {
	...
	public def JGFtidyup(): void = @ClockedM(SeriesTest.c) {
		freeTestData();
	}

	public def JGFrun(var size: int): void = @ClockedM(SeriesTest.c) {
