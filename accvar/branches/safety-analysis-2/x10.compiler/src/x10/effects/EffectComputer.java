...
public class EffectComputer extends ContextVisitor {
	...
	protected NodeVisitor enterCall(Node n) throws SemanticException {
		   EffectComputer v = ((X10Del) n.del()).computeEffectsEnter(this); 
	        //	   System.out.println("Enter this" + v);
		//   EffectComputer x = (EffectComputer )  n.del();		   
	        // EffectComputer v = ((X10Del) (EffectComputer) n.del()).computeEffectsEnter(this); 
	        // EffectComputer v = ((EffectComputer) n.del()).computeEffectsEnter(this);
		   if ( v != null) { 
