...
PGAS model to the {\em globally asynchronous, locally synchronous}
...
\XtenCurrVer revisits the language design from the ground up, introducing the following features:
The syntax of the language is more concise.
The object model has been extended to support unboxed objects.
The type system is extended to support genericity and constraints on types.
...
as builtin type constructors.  Closures and function types are supported.
