...
CFLAGS1     		:= -g -pg -DSMPONLY $(CFLAGS_GEN) $(CFLAGS_THR) \
			   -I$(SIMPLE_DIR)/$(INC_DIR) \
			   $(CFLAGS_SPRNG) -g 
#CFLAGS1     		:= CAS.il -DSMPONLY $(CFLAGS_GEN) $(CFLAGS_THR) \
			   -I$(SIMPLE_DIR)/$(INC_DIR) \
#			   $(CFLAGS_SPRNG) -g 
#CFLAGS1			:= -DSMPONLY -g -I$(SIMPLE_DIR)/$(INC_DIR) $(CFLAGS_SPRNG)
#CFLAGS1			:= -DSMPONLY -mt -xarch=v9a -xprefetch -DSOLARIS_NATIVE -DSOLARIS -g -I$(SIMPLE_DIR)/$(INC_DIR) $(CFLAGS_SPRNG)
LIBS1       		:= -g -pg -L$(SIMPLE_DIR)/$(LIB_DIR) $(SMPLIBS) $(THR_LIB) \
			   $(LIBS_SPRNG) #-bmaxdata:2000000000
