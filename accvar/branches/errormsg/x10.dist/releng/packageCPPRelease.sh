...
eval tar -cvzf "$cdir/$tarfile" --exclude=.svn INSTALL.txt README.txt RELEASE.NOTES.txt bin/{x10,x10c,x10c++,X10Launcher} epl-v10.html etc include stdlib lib/*.jar lib/${PLAT_LIBPAT} samples
