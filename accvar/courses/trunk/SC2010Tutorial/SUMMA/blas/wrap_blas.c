...
// C = alpha*op(A) * op(B) + beta*C
void matrixT_matrixT_mult(double* A, double* B, double* C, int* dim, double* scale, int* trans)
{
...
void matrixT_vector_mult(double* A, double* x, double* y, int* dim, double* scale, int transA)
{
  char tA = transA?'T':'N';
