...
namespace x10 {
    namespace lang {
        ...
        template<class P1, class P2, class P3, class P4, class R> class Fun_0_4 : public x10aux:: AnyFun {
            ...
            static R apply(x10aux::ref<x10::lang::Reference> recv, P1 arg1, P2 arg2, P3 arg3, P4 arg4) {
                return (recv.operator->()->*(x10aux::findITable<Fun_0_4<P1, P2, P3, P4, R> >(recv->_getITables())->apply))(arg1, arg2, arg3, arg4);
            }
