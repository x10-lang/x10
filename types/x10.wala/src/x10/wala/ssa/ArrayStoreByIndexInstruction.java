...
public class ArrayStoreByIndexInstruction extends ArrayReferenceByIndexInstruction {
    private final int value;

    public ArrayStoreByIndexInstruction(int arrayRef, int[] indices, int value, TypeReference declaredType) {
	...
	return ((AstX10InstructionFactory)insts).ArrayStoreByIndex(newArray, newIndices, newValue, declaredType);
    }
