...
public class PlaceOfPointInstruction extends SSAAbstractUnaryInstruction {

    public PlaceOfPointInstruction(int hasNextValue, int regionIter) {
	super(hasNextValue, regionIter);
    }

    public SSAInstruction copyForSSA(SSAInstructionFactory insts, int[] defs, int[] uses) {
	return ((AstX10InstructionFactory)insts).PlaceOfPoint((defs != null ? defs[0] : getDef(0)), (uses != null ? uses[0] : getUse(0)));
    }
