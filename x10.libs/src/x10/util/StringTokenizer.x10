/*
 *  Copyright (c) IBM 2010
 *
 *  This file is derived from code in Apache Harmony Project, which was
 *  licensed to the Apache Software Foundation (ASF) under one or more
 *  contributor license agreements.  See the NOTICE file distributed with
 *  this work for additional information regarding copyright ownership.
 *
 *  IBM licenses this file to You under the Apache License, Version 2.0
...
public class StringTokenizer {
    ...
    private val returnDelimiters:Boolean;
     ...
     */
    public def this(string:String, delimiters:String) {
     ...
     */
    public def this(string:String, delimiters:String, returnDelimiters:Boolean) {
        if (string != null) {
            this.string = string;
     ...
     */
    public def countTokens():Int {
        var count:Int = 0;
        var inToken:Boolean = false;
        for (var i:Int = position, length:Int = string.length(); i < length; i++) {
     ...
     *                if no tokens remain.
     */
    public def nextToken(delims:String) {
