...
public final class UnresolvedType implements Type, X10JavaSerializable {
	...
	private static final UnresolvedType[] params = { new UnresolvedType(0),
			new UnresolvedType(1), new UnresolvedType(2),
			new UnresolvedType(3), new UnresolvedType(4),
			new UnresolvedType(5), new UnresolvedType(6),
			new UnresolvedType(7), new UnresolvedType(8),
	...
	public static X10JavaSerializable $_deserialize_body(UnresolvedType $_obj,
			X10JavaDeserializer $deserializer) {
		throw new java.lang.UnsupportedOperationException();
	}
