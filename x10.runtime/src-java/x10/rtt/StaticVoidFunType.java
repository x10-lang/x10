...
public final class StaticVoidFunType<T> extends RuntimeType<T> {
	...
	public static <T> StaticVoidFunType/* <T> */make(Class<?> javaClass) {
		if (useCache) {
			...
			if (type == null) {
				StaticVoidFunType<?> type0 = new StaticVoidFunType<T>(
						javaClass, null, null);
	...
	public String typeName(Object o) {
		// Note: assume that the first parent in this RuntimeType is the
		// parameterized type which corresponds to the function type
