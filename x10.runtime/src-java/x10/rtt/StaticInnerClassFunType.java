...
public class StaticInnerClassFunType<T> extends RuntimeType<T> {
    
    public StaticInnerClassFunType(Class<?> c) {
        super(c);
    }
    
    public StaticInnerClassFunType(Class<?> c, Variance[] variances) {
        super(c, variances);
    }

    public StaticInnerClassFunType(Class<?> c, Type<?>[] parents) {
        super(c, parents);
    }
    
    public StaticInnerClassFunType(Class<?> c, Variance[] variances, Type<?>[] parents) {
