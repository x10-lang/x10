...
public class Types {
	...
	// not used because primitives has their own @Native and they are boxed when
	// converted to Any
	...
	public static Object $box(Object o) {
		...
		if (o instanceof java.lang.Boolean) {
			return x10.core.Boolean
					.$box(((java.lang.Boolean) o).booleanValue());
		}
		return o;
	}
	...
	/*
	 * returns runtime type for known types. mainly for primitives, string and
	 * exceptions.
	 */
	public static RuntimeType/* <?> */getRTTForKnownType(Class<?> javaClass) {
		if (java.lang.Object.class.equals(javaClass)) {
			...
			if (java.lang.RuntimeException.class.isAssignableFrom(javaClass)) {
				...
				} else if (java.lang.ArithmeticException.class
						.equals(javaClass)) {
					return ARITHMETIC_EXCEPTION;
				} else if (java.lang.UnsupportedOperationException.class
						.equals(javaClass)) {
					return UNSUPPORTED_OPERATION_EXCEPTION;
				} else if (java.util.NoSuchElementException.class
						.equals(javaClass)) {
					return NO_SUCH_ELEMENT_EXCEPTION;
				} else if (java.lang.ArrayIndexOutOfBoundsException.class
						.equals(javaClass)) {
					return ARRAY_INDEX_OUT_OF_BOUNDS_EXCEPTION;
				} else if (java.lang.StringIndexOutOfBoundsException.class
						.equals(javaClass)) {
					return STRING_INDEX_OUT_OF_BOUNDS_EXCEPTION;
				} else if (java.lang.IndexOutOfBoundsException.class
						.equals(javaClass)) {
					return INDEX_OUT_OF_BOUNDS_EXCEPTION;
				} else if (java.lang.NumberFormatException.class
						.equals(javaClass)) {
					return NUMBER_FORMAT_EXCEPTION;
				} else if (java.lang.IllegalArgumentException.class
						.equals(javaClass)) {
					return ILLEGAL_ARGUMENT_EXCEPTION;
				} else if (java.lang.IllegalStateException.class
						.equals(javaClass)) {
	...
	// Struct is not an X10 type, but it has RTT for runtime type checking such
	// as instanceof
	...
	// create rtt of comparable before all types that implement comparable (e.g.
	// int)
	public static final RuntimeType<Comparable> COMPARABLE = new NamedType<Comparable>(
			"x10.lang.Comparable", Comparable.class, RuntimeType.INVARIANTS(1),
			null) {
	...
	public static final RuntimeType<java.lang.Throwable> CHECKED_THROWABLE = new NamedType<java.lang.Throwable>(
			"x10.lang.CheckedThrowable", java.lang.Throwable.class, null,
			new Type[] { ANY }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return CHECKED_THROWABLE;
	...
	public static final RuntimeType<java.lang.Exception> CHECKED_EXCEPTION = new NamedType<java.lang.Exception>(
			"x10.lang.CheckedException", java.lang.Exception.class, null,
	...
	public static final RuntimeType<java.lang.RuntimeException> EXCEPTION = new NamedType<java.lang.RuntimeException>(
			"x10.lang.Exception", java.lang.RuntimeException.class, null,
	...
	public static final RuntimeType<java.lang.NullPointerException> NULL_POINTER_EXCEPTION = new NamedType<java.lang.NullPointerException>(
			...
			java.lang.NullPointerException.class, null,
			new Type[] { EXCEPTION }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return NULL_POINTER_EXCEPTION;
	...
	public static final RuntimeType<java.lang.ClassCastException> CLASS_CAST_EXCEPTION = new NamedType<java.lang.ClassCastException>(
			"x10.lang.ClassCastException", java.lang.ClassCastException.class,
			null, new Type[] { EXCEPTION }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return CLASS_CAST_EXCEPTION;
		}
	...
	public static final RuntimeType<java.lang.IndexOutOfBoundsException> INDEX_OUT_OF_BOUNDS_EXCEPTION = new NamedType<java.lang.IndexOutOfBoundsException>(
			...
			java.lang.IndexOutOfBoundsException.class, null,
			new Type[] { EXCEPTION }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return INDEX_OUT_OF_BOUNDS_EXCEPTION;
	...
	public static final RuntimeType<java.lang.ArrayIndexOutOfBoundsException> ARRAY_INDEX_OUT_OF_BOUNDS_EXCEPTION = new NamedType<java.lang.ArrayIndexOutOfBoundsException>(
			...
			java.lang.ArrayIndexOutOfBoundsException.class, null,
	...
	public static final RuntimeType<java.lang.StringIndexOutOfBoundsException> STRING_INDEX_OUT_OF_BOUNDS_EXCEPTION = new NamedType<java.lang.StringIndexOutOfBoundsException>(
			...
			java.lang.StringIndexOutOfBoundsException.class, null,
			new Type[] { INDEX_OUT_OF_BOUNDS_EXCEPTION }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return STRING_INDEX_OUT_OF_BOUNDS_EXCEPTION;
	...
	public static final RuntimeType<java.lang.ArithmeticException> ARITHMETIC_EXCEPTION = new NamedType<java.lang.ArithmeticException>(
			...
			java.lang.ArithmeticException.class, null, new Type[] { EXCEPTION }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return ARITHMETIC_EXCEPTION;
		}
	...
	public static final RuntimeType<java.lang.IllegalStateException> ILLEGAL_STATE_EXCEPTION = new NamedType<java.lang.IllegalStateException>(
			...
			java.lang.IllegalStateException.class, null,
			new Type[] { EXCEPTION }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return ILLEGAL_STATE_EXCEPTION;
	...
	public static final RuntimeType<java.lang.IllegalArgumentException> ILLEGAL_ARGUMENT_EXCEPTION = new NamedType<java.lang.IllegalArgumentException>(
			...
			java.lang.IllegalArgumentException.class, null,
			new Type[] { EXCEPTION }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return ILLEGAL_ARGUMENT_EXCEPTION;
	...
	public static final RuntimeType<java.lang.NumberFormatException> NUMBER_FORMAT_EXCEPTION = new NamedType<java.lang.NumberFormatException>(
			...
			java.lang.NumberFormatException.class, null,
	...
	public static final RuntimeType<java.lang.UnsupportedOperationException> UNSUPPORTED_OPERATION_EXCEPTION = new NamedType<java.lang.UnsupportedOperationException>(
			...
			java.lang.UnsupportedOperationException.class, null,
			new Type[] { EXCEPTION }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return UNSUPPORTED_OPERATION_EXCEPTION;
	...
	public static final RuntimeType<java.util.NoSuchElementException> NO_SUCH_ELEMENT_EXCEPTION = new NamedType<java.util.NoSuchElementException>(
			...
			java.util.NoSuchElementException.class, null,
			new Type[] { EXCEPTION }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return NO_SUCH_ELEMENT_EXCEPTION;
	...
	public static final RuntimeType<java.lang.Error> ERROR = new NamedType<java.lang.Error>(
			"x10.lang.Error", java.lang.Error.class, null,
			new Type[] { CHECKED_THROWABLE }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return ERROR;
	...
	public static final RuntimeType<java.lang.AssertionError> ASSERTION_ERROR = new NamedType<java.lang.AssertionError>(
			"x10.lang.AssertionError", java.lang.AssertionError.class, null,
			new Type[] { ERROR }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return ASSERTION_ERROR;
	...
	public static final RuntimeType<java.lang.StackOverflowError> STACK_OVERFLOW_ERROR = new NamedType<java.lang.StackOverflowError>(
			"x10.lang.StackOverflowError", java.lang.StackOverflowError.class,
			null, new Type[] { ERROR }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return STACK_OVERFLOW_ERROR;
	...
	public static final RuntimeType<java.lang.OutOfMemoryError> OUT_OF_MEMORY_ERROR = new NamedType<java.lang.OutOfMemoryError>(
			"x10.lang.OutOfMemoryError", java.lang.OutOfMemoryError.class,
			null, new Type[] { ERROR }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return OUT_OF_MEMORY_ERROR;
	...
	public static final RuntimeType<java.lang.InternalError> INTERNAL_ERROR = new NamedType<java.lang.InternalError>(
			"x10.lang.InternalError", java.lang.InternalError.class, null,
			new Type[] { ERROR }) {
		// make sure deserialized RTT object is not duplicated
		private Object readResolve() throws java.io.ObjectStreamException {
			return INTERNAL_ERROR;
	...
	public static final x10.core.UByte UBYTE_ZERO = x10.core.UByte
			.$box((byte) 0);
	public static final x10.core.UShort USHORT_ZERO = x10.core.UShort
			.$box((short) 0);
	public static final x10.core.UInt UINT_ZERO = x10.core.UInt.$box(0);
	public static final x10.core.ULong ULONG_ZERO = x10.core.ULong
			.$box((long) 0);
	...
	public static boolean asboolean(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.Boolean");
		}
		if (typeParamOrAny instanceof x10.core.Boolean)
			return x10.core.Boolean.$unbox((x10.core.Boolean) typeParamOrAny);
		else if (typeParamOrAny instanceof java.lang.Boolean) {
			return (java.lang.Boolean) typeParamOrAny;
		}
	...
	public static char aschar(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.Char");
		}
		if (typeParamOrAny instanceof x10.core.Char)
			return x10.core.Char.$unbox((x10.core.Char) typeParamOrAny);
		else if (typeParamOrAny instanceof java.lang.Character) {
			return (java.lang.Character) typeParamOrAny;
		}
	...
	public static byte asbyte(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.Byte");
		}
		if (isNumericType(origRTT)) {
			return ((java.lang.Number) typeParamOrAny).byteValue();
		} else {
			if (typeParamOrAny instanceof x10.core.Byte)
				return x10.core.Byte.$unbox((x10.core.Byte) typeParamOrAny);
			else if (typeParamOrAny instanceof java.lang.Byte) {
				return (java.lang.Byte) typeParamOrAny;
			}
		}
	...
	public static short asshort(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.Short");
		}
		if (isNumericType(origRTT)) {
			return ((java.lang.Number) typeParamOrAny).shortValue();
		} else {
			if (typeParamOrAny instanceof x10.core.Short)
				return x10.core.Short.$unbox((x10.core.Short) typeParamOrAny);
			else if (typeParamOrAny instanceof java.lang.Short) {
				return (java.lang.Short) typeParamOrAny;
			}
		}
	...
	public static int asint(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.Int");
		}
		if (isNumericType(origRTT)) {
			return ((java.lang.Number) typeParamOrAny).intValue();
		} else {
			if (typeParamOrAny instanceof x10.core.Int)
				return x10.core.Int.$unbox((x10.core.Int) typeParamOrAny);
			else if (typeParamOrAny instanceof java.lang.Integer) {
				return (java.lang.Integer) typeParamOrAny;
			}
		}
	...
	public static long aslong(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.Long");
		}
		if (isNumericType(origRTT)) {
			return ((java.lang.Number) typeParamOrAny).longValue();
		} else {
			if (typeParamOrAny instanceof x10.core.Long) {
				return x10.core.Long.$unbox((x10.core.Long) typeParamOrAny);
			} else if (typeParamOrAny instanceof java.lang.Long) {
				return (java.lang.Long) typeParamOrAny;
			}
		}
	...
	public static float asfloat(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.Float");
		}
		if (isNumericType(origRTT)) {
			return ((java.lang.Number) typeParamOrAny).floatValue();
		} else {
			if (typeParamOrAny instanceof x10.core.Float) {
				return x10.core.Float.$unbox((x10.core.Float) typeParamOrAny);
			} else if (typeParamOrAny instanceof java.lang.Float) {
				return (java.lang.Float) typeParamOrAny;
			}
		}
	...
	public static double asdouble(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.Double");
		}
		if (isNumericType(origRTT)) {
			return ((java.lang.Number) typeParamOrAny).doubleValue();
		} else {
			if (typeParamOrAny instanceof x10.core.Double) {
				return x10.core.Double.$unbox((x10.core.Double) typeParamOrAny);
			} else if (typeParamOrAny instanceof java.lang.Double) {
				return (java.lang.Double) typeParamOrAny;
			}
		}
	...
	public static byte asUByte(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.UByte");
		}
		if (isNumericType(origRTT)) {
			return ((java.lang.Number) typeParamOrAny).byteValue();
		} else {
			if (typeParamOrAny instanceof x10.core.UByte) {
				return x10.core.UByte.$unbox((x10.core.UByte) typeParamOrAny);
			} else if (typeParamOrAny instanceof java.lang.Byte) {
				return (java.lang.Byte) typeParamOrAny;
			}
		}
	...
	// not used
	// public static Object asBoxedUByte(Object typeParamOrAny, Type<?>
	// origRTT){
	...
	public static short asUShort(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.UShort");
		}
		if (isNumericType(origRTT)) {
			return ((java.lang.Number) typeParamOrAny).shortValue();
		} else {
			if (typeParamOrAny instanceof x10.core.UShort) {
				return x10.core.UShort.$unbox((x10.core.UShort) typeParamOrAny);
			} else if (typeParamOrAny instanceof java.lang.Short) {
				return (java.lang.Short) typeParamOrAny;
			}
		}
	...
	// not used
	// public static Object asBoxedUShort(Object typeParamOrAny, Type<?>
	// origRTT){
	...
	public static int asUInt(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.UInt");
		}
		if (isNumericType(origRTT)) {
			return ((java.lang.Number) typeParamOrAny).intValue();
		} else {
			if (typeParamOrAny instanceof x10.core.UInt) {
				return x10.core.UInt.$unbox((x10.core.UInt) typeParamOrAny);
			} else if (typeParamOrAny instanceof java.lang.Integer) {
				return (java.lang.Integer) typeParamOrAny;
			}
		}
	...
	public static long asULong(Object typeParamOrAny, Type<?> origRTT) {
		if (typeParamOrAny == null) {
			nullIsCastToStruct("x10.lang.ULong");
		}
		if (isNumericType(origRTT)) {
			return ((java.lang.Number) typeParamOrAny).longValue();
		} else {
			if (typeParamOrAny instanceof x10.core.ULong) {
				return x10.core.ULong.$unbox((x10.core.ULong) typeParamOrAny);
			} else if (typeParamOrAny instanceof java.lang.Long) {
				return (java.lang.Long) typeParamOrAny;
			}
		}
	...
	// not used
	// public static Object asBoxedULong(Object typeParamOrAny, Type<?>
	// origRTT){
	...
	public static Object asStruct(Type<?> rtt, Object typeParamOrAny) {
		...
		// N.B. ClassCastException is not explicitly checked here since it will
		// be checked by a Java cast of the return value
		return typeParamOrAny;
	}

	// FIXME this should be replaced by virtual method for user defined
	// conversion
	private static Object conversion(Type<?> rtt, Object primOrTypeParam,
			boolean convert) {
		...
		if (rtt == BOOLEAN) {
			return x10.core.Boolean.$box(asboolean(primOrTypeParam,
					convert ? BOOLEAN : null));
		}
		if (rtt == CHAR) {
			return x10.core.Char.$box(aschar(primOrTypeParam, convert ? CHAR
					: null));
		}
		if (rtt == BYTE) {
			return x10.core.Byte.$box(asbyte(primOrTypeParam, convert ? BYTE
					: null));
		}
		if (rtt == SHORT) {
			return x10.core.Short.$box(asshort(primOrTypeParam, convert ? SHORT
					: null));
		}
		if (rtt == INT) {
			return x10.core.Int.$box(asint(primOrTypeParam, convert ? INT
					: null));
		}
		if (rtt == LONG) {
			return x10.core.Long.$box(aslong(primOrTypeParam, convert ? LONG
					: null));
		}
		if (rtt == FLOAT) {
			return x10.core.Float.$box(asfloat(primOrTypeParam, convert ? FLOAT
					: null));
		}
		if (rtt == DOUBLE) {
			return x10.core.Double.$box(asdouble(primOrTypeParam,
					convert ? DOUBLE : null));
		}
		if (rtt == UBYTE) {
			return x10.core.UByte.$box(asUByte(primOrTypeParam, convert ? UBYTE
					: null));
		}
		if (rtt == USHORT) {
			return x10.core.UShort.$box(asUShort(primOrTypeParam,
					convert ? USHORT : null));
		}
		if (rtt == UINT) {
			return x10.core.UInt.$box(asUInt(primOrTypeParam, convert ? UINT
					: null));
		}
		if (rtt == ULONG) {
			return x10.core.ULong.$box(asULong(primOrTypeParam, convert ? ULONG
					: null));
		}
	...
	private static void nullIsCastToStruct(Type<?> rtt) {
		throw new java.lang.ClassCastException(rtt.typeName());
	}

	private static void nullIsCastToStruct(String msg) {
	...
	public static <T> T cast(final java.lang.Object self, Type<?> rtt) {
		// XTENLANG-3093
		if (self == null) {
			if (rtt == null || isNullable(rtt))
				return null;
			throw new java.lang.ClassCastException(rtt.typeName());
		}
		if (rtt != null && !rtt.isInstance(self))
			throw new java.lang.ClassCastException(rtt.typeName());
		return (T) self;
	}
	...
	public static <T> T castConversion(final java.lang.Object self, Type<?> rtt) {
		...
		if (rtt != null && !rtt.isInstance(ret))
			throw new java.lang.ClassCastException(rtt.typeName());
		return ret;
	}
	...
	public static Object zeroValue(Type<?> rtt) {
		...
		if (isStructType(rtt)) {
			...
			if (rtt == BOOLEAN)
				return BOOLEAN_ZERO;
			// N.B. to enable following special paths, make corresponding $RTTs
			// singleton
			// N.B. since GlobalRef and IndexedMemoryChunk have their own zero
			// value constructor, special paths are no longer needed
			// if (rtt == x10.core.IndexedMemoryChunk.$RTT) return new
			// x10.core.IndexedMemoryChunk(actualTypeArguments[0],
			// (java.lang.System) null);
			// if (rtt == x10.core.GlobalRef.$RTT) return new
			// x10.core.GlobalRef(actualTypeArguments[0], (java.lang.System)
			// null);
			...
			try {
				...
				for (java.lang.reflect.Constructor<?> ctor0 : impl
						.getConstructors()) {
					paramTypes = ctor0.getParameterTypes();
					if (paramTypes.length >= 1
							&& paramTypes[paramTypes.length - 1]
									.equals(java.lang.System.class)) {
						ctor = ctor0;
						break;
					}
				}
				...
				assert actualTypeArguments == null ? paramTypes.length == 1/*
																			 * (java
																			 * .
																			 * lang
																			 * .
																			 ...
																			 * null
																			 */
						: paramTypes.length == actualTypeArguments.length/*
																		 * T1,T2,
																		 * ...
																		 */+ 1/*
																			 * (java
