...
/**
 * This class provides a set of static methods that provide low-level memory
 * synchronization barriers.
 * 
 * For performance, these methods should be implemented by the VM as instrinsics
 * but can be simulated using load/stores to volatile variables.
 */
