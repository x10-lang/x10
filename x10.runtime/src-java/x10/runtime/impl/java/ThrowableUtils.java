...
public abstract class ThrowableUtils {
	...
	static {
		try {
			...
			x10Class = Class.forName(x10Name).asSubclass(
	...
	private static java.lang.RuntimeException asX10Exception(
			Class<? extends java.lang.RuntimeException> x10Class,
			java.lang.String message, java.lang.Throwable t) {
		try {
			java.lang.RuntimeException xe = x10Class.getConstructor(
					java.lang.String.class).newInstance(message);
			if (t != null) {
	...
	public static java.lang.RuntimeException ensureX10Exception(
			java.io.IOException e) {
		Class<? extends java.lang.RuntimeException> x10Class = x10Exceptions
				.get(e.getClass());
	...
	public static java.lang.RuntimeException ensureX10Exception(
		...
		} else if (!supportConversionForJavaErrors
				&& e instanceof java.lang.Error) {
	...
	public static x10.array.Array<java.lang.String> getStackTrace(
			java.lang.Throwable e) {
		...
		return x10.runtime.impl.java.ArrayUtils
				.<java.lang.String> makeArrayFromJavaArray(
						x10.rtt.Types.STRING, str);
	}
