...
public final class NativeFile extends java.io.File implements Any {
	...
	public x10.array.Array listInternal() {
		return x10.runtime.impl.java.ArrayUtils.makeArrayFromJavaArray(
				Types.STRING, list());
	}
	...
	//
	public static final RuntimeType<NativeFile> $RTT = NamedType
			.<NativeFile> make("x10.io.File.NativeFile", NativeFile.class);

	public RuntimeType<NativeFile> $getRTT() {
		return $RTT;
	}
