...
public class OutputStream extends Ref {
	...
	public final OutputStream x10$io$OutputStreamWriter$OutputStream$$init$S(
	...
	// } catch (java.io.IOException e) {
	// throw
	// x10.runtime.impl.java.ThrowableUtils.getCorrespondingX10Throwable(e);
	// }
	// }
	...
	//
	public static final RuntimeType<OutputStream> $RTT = NamedType
			.<OutputStream> make("x10.io.OutputStreamWriter.OutputStream",
					OutputStream.class);
	...
	//
	// NOTE: this class is only used in @Native annotation of
	...
	public static class WriterOutputStream extends OutputStream {
		...
		public final WriterOutputStream x10$io$OutputStreamWriter$OutputStream$WriterOutputStream$$init$S(
				x10.io.Writer w) {
			// NOTE: since the backing stream is not set, all APIs of
			// OutputStream must be overridden.
		...
		public static final RuntimeType<WriterOutputStream> $RTT = NamedType
				.<WriterOutputStream> make(
