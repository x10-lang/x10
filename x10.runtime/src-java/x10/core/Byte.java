...
/**
 * Represents a boxed Byte value. Boxed representation is used when casting an
 * Byte value to type Any, parameter type T or superinterfaces such as
 * Comparable<Byte>.
 */
final public class Byte extends java.lang.Number implements
		StructI,
		java.lang.Comparable<Byte>,
		// for
		// X10PrettyPrinterVisitor.exposeSpecialDispatcherThroughSpecialInterface
		// x10.lang.Arithmetic<Byte>, x10.lang.Bitwise<Byte>,
		// x10.util.Ordered<Byte>
		x10.core.Arithmetic.x10$lang$Byte, x10.core.Bitwise.x10$lang$Byte,
		x10.util.Ordered<Byte> {
	...
	private abstract static class Cache {
		static final boolean enabled = java.lang.Boolean.parseBoolean(System
				.getProperty("x10.lang.Byte.Cache.enabled", "false"));
	...
	public static Byte $box(int value) { // int because literals essentially
	...
	public boolean equals(Object value) {
		...
		} else if (value instanceof java.lang.Byte) { // integer literals come
														// here as Byte
														// autoboxed values
	...
	public Byte $minus$G() {
		return Byte.$box(-$value);
	}

	public Byte $plus(java.lang.Object b, Type t) {
		return Byte.$box($value + ((Byte) b).$value);
	}

	public Byte $minus(java.lang.Object b, Type t) {
		return Byte.$box($value - ((Byte) b).$value);
	}

	public Byte $times(java.lang.Object b, Type t) {
		return Byte.$box($value * ((Byte) b).$value);
	}

	public Byte $over(java.lang.Object b, Type t) {
		return Byte.$box($value / ((Byte) b).$value);
	}

	// for
	// X10PrettyPrinterVisitor.exposeSpecialDispatcherThroughSpecialInterface
	public byte $plus$B(java.lang.Object b, Type t) {
		return (byte) ($value + ((Byte) b).$value);
	}

	public byte $minus$B(java.lang.Object b, Type t) {
		return (byte) ($value - ((Byte) b).$value);
	}

	public byte $times$B(java.lang.Object b, Type t) {
		return (byte) ($value * ((Byte) b).$value);
	}

	public byte $over$B(java.lang.Object b, Type t) {
		return (byte) ($value / ((Byte) b).$value);
	}
	...
	public Byte $ampersand(java.lang.Object b, Type t) {
		return Byte.$box($value & ((Byte) b).$value);
	}

	public Byte $bar(java.lang.Object b, Type t) {
		return Byte.$box($value | ((Byte) b).$value);
	}

	public Byte $caret(java.lang.Object b, Type t) {
		return Byte.$box($value ^ ((Byte) b).$value);
	}

	public Byte $left$G(int count) {
		return Byte.$box($value << count);
	}

	public Byte $right$G(int count) {
		return Byte.$box($value >> count);
	}

	public Byte $unsigned_right$G(int count) {
		return Byte.$box($value >>> count);
	}

	// for
	// X10PrettyPrinterVisitor.exposeSpecialDispatcherThroughSpecialInterface
	public byte $ampersand$B(java.lang.Object b, Type t) {
		return (byte) ($value & ((Byte) b).$value);
	}

	public byte $bar$B(java.lang.Object b, Type t) {
		return (byte) ($value | ((Byte) b).$value);
	}

	public byte $caret$B(java.lang.Object b, Type t) {
		return (byte) ($value ^ ((Byte) b).$value);
	}

	// implements Ordered<Byte>
	public java.lang.Object $lt(java.lang.Object b, Type t) {
		return x10.core.Boolean.$box($value < ((Byte) b).$value);
	}
	...
	public static X10JavaSerializable $_deserialize_body(Byte $_obj,
			X10JavaDeserializer $deserializer) throws IOException {
