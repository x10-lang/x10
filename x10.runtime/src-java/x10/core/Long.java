...
/**
 * Represents a boxed Long value. Boxed representation is used when casting an
 * Long value to type Any, parameter type T or superinterfaces such as
 * Comparable<Long>.
 */
final public class Long extends java.lang.Number implements
		StructI,
		java.lang.Comparable<Long>,
		// for
		// X10PrettyPrinterVisitor.exposeSpecialDispatcherThroughSpecialInterface
		// x10.lang.Arithmetic<Long>, x10.lang.Bitwise<Long>,
		// x10.util.Ordered<Long>
		x10.core.Arithmetic.x10$lang$Long, x10.core.Bitwise.x10$lang$Long,
		x10.util.Ordered<Long> {
	...
	private abstract static class Cache {
		static final boolean enabled = java.lang.Boolean.parseBoolean(System
				.getProperty("x10.lang.Long.Cache.enabled", "false"));
	...
	public boolean equals(Object value) {
		...
		} else if (value instanceof java.lang.Long) { // integer literals come
														// here as Long
														// autoboxed values
	...
	public Long $plus(java.lang.Object b, Type t) {
		return Long.$box($value + ((Long) b).$value);
	}

	public Long $minus(java.lang.Object b, Type t) {
		return Long.$box($value - ((Long) b).$value);
	}

	public Long $times(java.lang.Object b, Type t) {
		return Long.$box($value * ((Long) b).$value);
	}

	public Long $over(java.lang.Object b, Type t) {
		return Long.$box($value / ((Long) b).$value);
	}

	// for
	// X10PrettyPrinterVisitor.exposeSpecialDispatcherThroughSpecialInterface
	public long $plus$J(java.lang.Object b, Type t) {
		return $value + ((Long) b).$value;
	}

	public long $minus$J(java.lang.Object b, Type t) {
		return $value - ((Long) b).$value;
	}

	public long $times$J(java.lang.Object b, Type t) {
		return $value * ((Long) b).$value;
	}

	public long $over$J(java.lang.Object b, Type t) {
		return $value / ((Long) b).$value;
	}
	...
	public Long $ampersand(java.lang.Object b, Type t) {
		return Long.$box($value & ((Long) b).$value);
	}

	public Long $bar(java.lang.Object b, Type t) {
		return Long.$box($value | ((Long) b).$value);
	}

	public Long $caret(java.lang.Object b, Type t) {
		return Long.$box($value ^ ((Long) b).$value);
	}

	public Long $left$G(int count) {
		return Long.$box($value << count);
	}

	public Long $right$G(int count) {
		return Long.$box($value >> count);
	}

	public Long $unsigned_right$G(int count) {
		return Long.$box($value >>> count);
	}

	// for
	// X10PrettyPrinterVisitor.exposeSpecialDispatcherThroughSpecialInterface
	public long $ampersand$J(java.lang.Object b, Type t) {
		return $value & ((Long) b).$value;
	}

	public long $bar$J(java.lang.Object b, Type t) {
		return $value | ((Long) b).$value;
	}

	public long $caret$J(java.lang.Object b, Type t) {
		return $value ^ ((Long) b).$value;
	}

	// implements Ordered<Long>
	public java.lang.Object $lt(java.lang.Object b, Type t) {
		return x10.core.Boolean.$box($value < ((Long) b).$value);
	}
	...
	public static X10JavaSerializable $_deserialize_body(Long $_obj,
			X10JavaDeserializer $deserializer) throws IOException {
