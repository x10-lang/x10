...
/**
 * Represents a boxed Float value. Boxed representation is used when casting an
 * Float value to type Any, parameter type T or superinterfaces such as
 * Comparable<Float>.
 */
final public class Float extends java.lang.Number implements StructI,
	...
	public static Float $box(float value) { // int because literals essentially
	...
	public static Float $box(Object obj) {
		if (obj instanceof Float)
			...
			return $box(((java.lang.Float) obj).floatValue());
	}
	...
	public Float $minus$G() {
		return Float.$box(-$value);
	}

	public Float $plus(java.lang.Object b, Type t) {
		return Float.$box($value + ((Float) b).$value);
	}

	public Float $minus(java.lang.Object b, Type t) {
		return Float.$box($value - ((Float) b).$value);
	}

	public Float $times(java.lang.Object b, Type t) {
		return Float.$box($value * ((Float) b).$value);
	}

	public Float $over(java.lang.Object b, Type t) {
		return Float.$box($value / ((Float) b).$value);
	}

	// for
	// X10PrettyPrinterVisitor.exposeSpecialDispatcherThroughSpecialInterface
	public float $plus$F(java.lang.Object b, Type t) {
		return $value + ((Float) b).$value;
	}

	public float $minus$F(java.lang.Object b, Type t) {
		return $value - ((Float) b).$value;
	}

	public float $times$F(java.lang.Object b, Type t) {
		return $value * ((Float) b).$value;
	}

	public float $over$F(java.lang.Object b, Type t) {
		return $value / ((Float) b).$value;
	}

	// implements Ordered<Float>
	public java.lang.Object $lt(java.lang.Object b, Type t) {
		return x10.core.Boolean.$box($value < ((Float) b).$value);
	}
	...
	public static X10JavaSerializable $_deserialize_body(Float $_obj,
			X10JavaDeserializer $deserializer) throws IOException {
