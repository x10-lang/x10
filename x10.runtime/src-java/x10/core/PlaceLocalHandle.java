...
public final class PlaceLocalHandle<T> implements java.io.Serializable,
	...
	// did here or by having the places get ids in "chunks" from the master id
	// server
	// at place 0.
	// Since we are thinking about making this change, I went ahead and did a
	// poor-man's
	...
	public static X10JavaSerializable $_deserialize_body(
			PlaceLocalHandle $_obj, X10JavaDeserializer $deserializer)
			throws IOException {
	...
	public static X10JavaSerializable $_deserializer(
		...
		PlaceLocalHandle $_obj = new PlaceLocalHandle(
				(java.lang.System[]) null, (Type<?>) null);
