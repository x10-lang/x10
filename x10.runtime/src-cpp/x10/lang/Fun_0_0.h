        ...
        template<class R> class Fun_0_0 {
            ...
            template <class I> struct itable {
                itable(x10_boolean (I::*equals)(x10::lang::Any*),
                       ...
                       R(I::*__apply)(),
                       R(I::*__apply__tm__)(x10tm::TMThread *SelfTM),
            ...
            static R __apply__tm__(x10tm::TMThread *SelfTM, Fun_0_0<R>* fun) {
				x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
				return (recv->*(x10aux::findITable<Fun_0_0<R> >(recv->_getITables())->__apply__tm__))(SelfTM);
			}
			static x10_boolean equals__tm__(x10tm::TMThread *SelfTM, Fun_0_0<R>* fun, x10::lang::Any* arg1) {
				x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
				return (recv->*(x10aux::findITable<Fun_0_0<R> >(recv->_getITables())->equals__tm__))(SelfTM, arg1);
			}
			static x10_int hashCode__tm__(x10tm::TMThread *SelfTM, Fun_0_0<R>* fun) {
				x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
				return (recv->*(x10aux::findITable<Fun_0_0<R> >(recv->_getITables())->hashCode__tm__))(SelfTM);
			}
			static x10::lang::String* toString__tm__(x10tm::TMThread *SelfTM, Fun_0_0<R>* fun) {
				x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
				return (recv->*(x10aux::findITable<Fun_0_0<R> >(recv->_getITables())->toString__tm__))(SelfTM);
			}
			static x10::lang::String* typeName__tm__(x10tm::TMThread *SelfTM, Fun_0_0<R>* fun) {
				x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
				return (recv->*(x10aux::findITable<Fun_0_0<R> >(recv->_getITables())->typeName__tm__))(SelfTM);
			}
        };
