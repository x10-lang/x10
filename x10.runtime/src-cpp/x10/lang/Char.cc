...
///////
x10_boolean CharNatives::isLowerCase__tm__(x10_char x) {
    /* FIXME: Unicode support */
    return islower((int) x.v);
}

x10_boolean CharNatives::isUpperCase__tm__(x10_char x) {
    /* FIXME: Unicode support */
    return isupper((int) x.v);
}

x10_boolean CharNatives::isTitleCase__tm__(x10_char x) {
    (void) x;
    UNIMPLEMENTED("isTitleCase");
    return false;
}

x10_boolean CharNatives::isDigit__tm__(x10_char x) {
    /* FIXME: Unicode support */
    return isdigit((int) x.v);
}

x10_boolean CharNatives::isLetter__tm__(x10_char x) {
    /* FIXME: Unicode support */
    return isalpha((int) x.v);
}

x10_boolean CharNatives::isLetterOrDigit__tm__(x10_char x) {
    /* FIXME: Unicode support */
    return isalnum((int) x.v);
}

x10_boolean CharNatives::isUnicodeIdentifierStart__tm__(x10_char x) {
    (void) x;
    UNIMPLEMENTED("isUnicodeIdentifierStart");
    return false;
}

x10_boolean CharNatives::isUnicodeIdentifierPart__tm__(x10_char x) {
    (void) x;
    UNIMPLEMENTED("isUnicodeIdentifierPart");
    return false;
}

x10_boolean CharNatives::isUnicodeIdentifierIgnorable__tm__(x10_char x) {
    (void) x;
    UNIMPLEMENTED("isUnicodeIdentifierIgnorable");
    return false;
}

x10_boolean CharNatives::isSpaceChar__tm__(x10_char x) {
    /* FIXME: Unicode support */
    return isWhitespace(x);
}

x10_boolean CharNatives::isWhitespace__tm__(x10_char x) {
    /* FIXME: Unicode support */
    return isspace((int) x.v);
}

x10_boolean CharNatives::isISOControl__tm__(x10_char x) {
    /* FIXME: Unicode support */
    return iscntrl((int) x.v);
}

x10_char CharNatives::toLowerCase__tm__(x10_char x) {
    /* FIXME: Unicode support */
    return (x10_char) tolower((int) x.v);
}

x10_char CharNatives::toUpperCase__tm__(x10_char x) {
    /* FIXME: Unicode support */
    return (x10_char) toupper((int) x.v);
}

x10_char CharNatives::toTitleCase__tm__(x10_char x) {
    /* FIXME: Proper title case support */
    return toUpperCase(x);
}
