...
namespace x10 {
    namespace lang {
        ...
        template<class P1, class P2, class P3, class R> class Fun_0_3 {
            public:
            ...
            template <class I> struct itable {
                itable(x10_boolean (I::*equals)(x10::lang::Any*),
                       ...
                       R(I::*__apply)(P1,P2,P3),
                       R(I::*__apply__tm__)(x10tm::TMThread *SelfTM, P1,P2,P3),
            ...
            static R __apply(Fun_0_3<P1,P2,P3,R>* fun, P1 arg1, P2 arg2, P3 arg3) {
                x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
                return (recv->*(x10aux::findITable<Fun_0_3<P1, P2, P3, R> >(recv->_getITables())->__apply))(arg1, arg2, arg3);
            }
            static x10_boolean equals(Fun_0_3<P1,P2,P3,R>* fun, x10::lang::Any* arg1) {
                x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
                return (recv->*(x10aux::findITable<Fun_0_3<P1, P2, P3, R> >(recv->_getITables())->equals))(arg1);
            }
            static x10_int hashCode(Fun_0_3<P1,P2,P3,R>* fun) {
                x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
                return (recv->*(x10aux::findITable<Fun_0_3<P1, P2, P3, R> >(recv->_getITables())->hashCode))();
            }
            static x10::lang::String* toString(Fun_0_3<P1,P2,P3,R>* fun) {
                x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
                return (recv->*(x10aux::findITable<Fun_0_3<P1, P2, P3, R> >(recv->_getITables())->toString))();
            }
            static x10::lang::String* typeName(Fun_0_3<P1,P2,P3,R>* fun) {
                x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
                return (recv->*(x10aux::findITable<Fun_0_3<P1, P2, P3, R> >(recv->_getITables())->typeName))();
            }
            //
            static R __apply__tm__(x10tm::TMThread *SelfTM, Fun_0_3<P1,P2,P3,R>* fun, P1 arg1, P2 arg2, P3 arg3) {
                x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
                return (recv->*(x10aux::findITable<Fun_0_3<P1, P2, P3, R> >(recv->_getITables())->__apply))(arg1, arg2, arg3);
            }
            static x10_boolean equals__tm__(x10tm::TMThread *SelfTM, Fun_0_3<P1,P2,P3,R>* fun, x10::lang::Any* arg1) {
                x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
                return (recv->*(x10aux::findITable<Fun_0_3<P1, P2, P3, R> >(recv->_getITables())->equals))(arg1);
            }
            static x10_int hashCode__tm__(x10tm::TMThread *SelfTM, Fun_0_3<P1,P2,P3,R>* fun) {
                x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
                return (recv->*(x10aux::findITable<Fun_0_3<P1, P2, P3, R> >(recv->_getITables())->hashCode))();
            }
            static x10::lang::String* toString__tm__(x10tm::TMThread *SelfTM, Fun_0_3<P1,P2,P3,R>* fun) {
                x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
                return (recv->*(x10aux::findITable<Fun_0_3<P1, P2, P3, R> >(recv->_getITables())->toString))();
            }
            static x10::lang::String* typeName__tm__(x10tm::TMThread *SelfTM, Fun_0_3<P1,P2,P3,R>* fun) {
                x10::lang::Reference* recv = reinterpret_cast<x10::lang::Reference*>(fun);
                return (recv->*(x10aux::findITable<Fun_0_3<P1, P2, P3, R> >(recv->_getITables())->typeName))();
            }
