...
/////
String* DoubleNatives::toHexString__tm__(x10tm::TMThread *SelfTM, x10_double value) {
    (void) value;
    UNIMPLEMENTED("toHexString");
    return NULL;
}

String* DoubleNatives::toString__tm__(x10tm::TMThread *SelfTM, x10_double value) {
    return to_string(value);
}

x10_double DoubleNatives::parseDouble__tm__(x10tm::TMThread *SelfTM, String* s) {
    const char *start = nullCheck(s)->c_str();
    char *end;
    errno = 0;
    x10_double ans = strtod(start, &end);
...
x10_boolean DoubleNatives::isNaN__tm__(x10tm::TMThread *SelfTM, x10_double x) {
    return x10aux::math::isnan(x);
}

x10_boolean DoubleNatives::isInfinite__tm__(x10tm::TMThread *SelfTM, x10_double x) {
    return x10aux::math::isinf(x);
}

x10_long DoubleNatives::toLongBits__tm__(x10tm::TMThread *SelfTM, x10_double x) {
    return isNaN(x) ? 0x7ff8000000000000LL : toRawLongBits(x);
}

x10_long DoubleNatives::toRawLongBits__tm__(x10tm::TMThread *SelfTM, x10_double x) {
    TypePunner tmp;
    tmp.d = x;
    return tmp.l;
}

x10_double DoubleNatives::fromLongBits__tm__(x10tm::TMThread *SelfTM, x10_long x) {
    TypePunner tmp;
    tmp.l = x;
    return tmp.d;
}

x10_byte DoubleNatives::toByte__tm__(x10tm::TMThread *SelfTM, x10_double value) {
    if (value > (x10_double)((x10_byte)0x7f)) return (x10_byte)0x7f;
    if (value < (x10_double)((x10_byte)0x80)) return (x10_byte)0x80;
    return (x10_byte)value;
}

x10_ubyte DoubleNatives::toUByte__tm__(x10tm::TMThread *SelfTM, x10_double value) {
    if (value > (x10_double)((x10_ubyte)0xff)) return (x10_byte)0xff;
    if (value < 0) return (x10_ubyte)0;
    return (x10_ubyte)value;
}

x10_short DoubleNatives::toShort__tm__(x10tm::TMThread *SelfTM, x10_double value) {
    if (value > (x10_double)((x10_short)0x7fff)) return (x10_short)0x7fff;
    if (value < (x10_double)((x10_short)0x8000)) return (x10_short)0x8000;
    return (x10_short)value;
}

x10_ushort DoubleNatives::toUShort__tm__(x10tm::TMThread *SelfTM, x10_double value) {
    if (value > (x10_double)((x10_ushort)0xffff)) return (x10_ushort)0xffff;
    if (value < 0) return (x10_ushort)0;
    return (x10_ushort)value;
}

x10_int DoubleNatives::toInt__tm__(x10tm::TMThread *SelfTM, x10_double value) {
    if (value > (x10_double)((x10_int)0x7fffffff)) return (x10_int)0x7fffffff;
    if (value < (x10_double)((x10_int)0x80000000)) return (x10_int)0x80000000;
    return (x10_int)value;
}

x10_uint DoubleNatives::toUInt__tm__(x10tm::TMThread *SelfTM, x10_double value) {
    if (value > (x10_double)((x10_uint)0xffffffff)) return (x10_uint)0xffffffff;
    if (value < 0) return (x10_uint)0;
    return (x10_uint)value;
}

x10_long DoubleNatives::toLong__tm__(x10tm::TMThread *SelfTM, x10_double value) {
    if (value > (x10_double)((x10_long)0x7fffffffffffffffLL)) return (x10_long)0x7fffffffffffffffLL;
    if (value < (x10_double)((x10_long)0x8000000000000000LL)) return (x10_long)0x8000000000000000LL;
    return (x10_long)value;
}

x10_ulong DoubleNatives::toULong__tm__(x10tm::TMThread *SelfTM, x10_double value) {
    if (value > (x10_double)((x10_ulong)0xffffffffffffffffLL)) return (x10_ulong)0xffffffffffffffffLL;
    if (value < 0) return (x10_ulong)0;
    return (x10_ulong)value;
}
