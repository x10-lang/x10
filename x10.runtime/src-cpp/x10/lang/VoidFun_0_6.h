...
namespace x10 {
    namespace lang {
        ...
        template<class P1, class P2, class P3, class P4, class P5, class P6> class VoidFun_0_6 {
            public:
            ...
            template <class Iface> struct itable {
                itable(x10_boolean (Iface::*equals)(::x10::lang::Any*),
                       ...
                       void(Iface::*__apply)(P1,P2,P3,P4,P5,P6),
            ...
            static void __apply(VoidFun_0_6<P1,P2,P3,P4,P5,P6>* fun, P1 arg1, P2 arg2, P3 arg3, P4 arg4, P5 arg5, P6 arg6) {
                ::x10::lang::Reference* recv = reinterpret_cast< ::x10::lang::Reference*>(fun);
                return (recv->*(::x10aux::findITable<VoidFun_0_6<P1,P2,P3,P4,P5,P6> >(recv->_getITables())->__apply))(arg1, arg2, arg3, arg4, arg5, arg6);
            }
            static x10_boolean equals(VoidFun_0_6<P1,P2,P3,P4,P5,P6>* fun, ::x10::lang::Any* arg1) {
                ::x10::lang::Reference* recv = reinterpret_cast< ::x10::lang::Reference*>(fun);
                return (recv->*(::x10aux::findITable<VoidFun_0_6<P1,P2,P3,P4,P5,P6> >(recv->_getITables())->equals))(arg1);
            }
            static x10_int hashCode(VoidFun_0_6<P1,P2,P3,P4,P5,P6>* fun) {
                ::x10::lang::Reference* recv = reinterpret_cast< ::x10::lang::Reference*>(fun);
                return (recv->*(::x10aux::findITable<VoidFun_0_6<P1,P2,P3,P4,P5,P6> >(recv->_getITables())->hashCode))();
            }
            static ::x10::lang::String* toString(VoidFun_0_6<P1,P2,P3,P4,P5,P6>* fun) {
                ::x10::lang::Reference* recv = reinterpret_cast< ::x10::lang::Reference*>(fun);
                return (recv->*(::x10aux::findITable<VoidFun_0_6<P1,P2,P3,P4,P5,P6> >(recv->_getITables())->toString))();
            }
            static ::x10::lang::String* typeName(VoidFun_0_6<P1,P2,P3,P4,P5,P6>* fun) {
                ::x10::lang::Reference* recv = reinterpret_cast< ::x10::lang::Reference*>(fun);
                return (recv->*(::x10aux::findITable<VoidFun_0_6<P1,P2,P3,P4,P5,P6> >(recv->_getITables())->typeName))();
            }
        };
