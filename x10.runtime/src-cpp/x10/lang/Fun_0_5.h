        ...
        template<class P1, class P2, class P3, class P4, class P5, class R> class Fun_0_5 {
            ...
            template <class Iface> struct itable {
                itable(x10_boolean (Iface::*equals)(::x10::lang::Any*),
                       ...
                       R(Iface::*__apply)(P1,P2,P3,P4,P5),
            ...
            static R __apply(Fun_0_5<P1,P2,P3,P4,P5,R>* fun, P1 arg1, P2 arg2, P3 arg3, P4 arg4, P5 arg5) {
                ::x10::lang::Reference* recv = reinterpret_cast< ::x10::lang::Reference*>(fun);
                return (recv->*(::x10aux::findITable<Fun_0_5<P1,P2,P3,P4,P5,R> >(recv->_getITables())->__apply))(arg1, arg2, arg3, arg4, arg5);
            }
            static x10_boolean equals(Fun_0_5<P1,P2,P3,P4,P5,R>* fun, ::x10::lang::Any* arg1) {
                ::x10::lang::Reference* recv = reinterpret_cast< ::x10::lang::Reference*>(fun);
                return (recv->*(::x10aux::findITable<Fun_0_5<P1,P2,P3,P4,P5,R> >(recv->_getITables())->equals))(arg1);
            }
            static x10_int hashCode(Fun_0_5<P1,P2,P3,P4,P5,R>* fun) {
                ::x10::lang::Reference* recv = reinterpret_cast< ::x10::lang::Reference*>(fun);
                return (recv->*(::x10aux::findITable<Fun_0_5<P1,P2,P3,P4,P5,R> >(recv->_getITables())->hashCode))();
            }
            static ::x10::lang::String* toString(Fun_0_5<P1,P2,P3,P4,P5,R>* fun) {
                ::x10::lang::Reference* recv = reinterpret_cast< ::x10::lang::Reference*>(fun);
                return (recv->*(::x10aux::findITable<Fun_0_5<P1,P2,P3,P4,P5,R> >(recv->_getITables())->toString))();
            }
            static ::x10::lang::String* typeName(Fun_0_5<P1,P2,P3,P4,P5,R>* fun) {
                ::x10::lang::Reference* recv = reinterpret_cast< ::x10::lang::Reference*>(fun);
                return (recv->*(::x10aux::findITable<Fun_0_5<P1,P2,P3,P4,P5,R> >(recv->_getITables())->typeName))();
            }
        };
