...
String* UIntNatives::toString(x10_uint value, x10_int radix) {
...
String* UIntNatives::toString(x10_uint value) {
    return to_string(value);
}

x10_uint UIntNatives::parseUInt(String* s, x10_int radix) {
