...
public class Java {
    ...
    @Native("java", "new x10.core.Rail((java.lang.System[]) null, #T$rtt).x10$lang$Rail$$init$S(new x10.core.IndexedMemoryChunk(#T$rtt, #a.length, #a), (x10.core.Rail.__0$1x10$lang$Rail$$T$2) null)")
