...
public final class String implements Comparable[String] {
     ...
     * @see #bytes()
     */
    @Native("java", "new x10.core.Rail<x10.core.Char>(x10.rtt.Types.CHAR, (#this).toCharArray().length, (#this).toCharArray())")
    @Native("c++", "(#this)->chars()")
     ...
     * @see #chars()
     */
    @Native("java", "new x10.core.Rail<x10.core.Byte>(x10.rtt.Types.BYTE, (#this).getBytes().length, (#this).getBytes())")
    @Native("c++", "(#this)->bytes()")
