 ...
 */
@NativeRep("java", "x10.core.GlobalObject", null, null)
@NativeRep("c++", "x10aux::ref<x10::lang::GlobalObject>", "x10::lang::GlobalObject", null)
        ...
        implements Global
{
    ...
    @Native("c++", "(#0)->at(#1)")
    public property safe def at(r:GlobalObject) = home==r.home;
