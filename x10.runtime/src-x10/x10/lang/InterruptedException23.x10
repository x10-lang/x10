 ...
 */
@NativeRep("java", "java.lang.InterruptedException", null, "x10.rtt.Types.INTERRUPTED_EXCEPTION")
class InterruptedException23 extends Exception23 {

    @Native("java", "new java.lang.InterruptedException()")
    public def this() { super(); }

    @Native("java", "new java.lang.InterruptedException(#message)")
