...
final public class Point(rank: Int) implements (Int) => Int, Ordered[Point(rank)] {
     ...
     */
    public safe def apply(i: Int): Int = coords(i);

    /**
     * Returns the coordinates as a <code>ValRail[Int]</code>.
     */

    public safe def coords(): ValRail[int] = coords;

    /**
     * Constructs a Point from a ValRail[int].
     */
    public static safe def make(cs: ValRail[int]): Point(cs.length) = new Point(cs);

    /**
     * Constructs a Point from a Rail[int]
     */
    public static safe def make(cs: Rail[int]): Point(cs.length) {
     ...
     */
    public static safe def make(rank:Int, init:(i:Int)=>int):Point(rank) {
        val a = ValRail.make[int](rank, init);
        return make(a);
    }


    public static safe def make(i0:int) = make([i0]);
    public static safe def make(i0:int, i1:int) = make([i0,i1]);
    public static safe def make(i0:int, i1:int, i2:int) = make([i0,i1,i2]);
    public static safe def make(i0:int, i1:int, i2:int, i3:int) = make([i0,i1,i2,i3]);
     ...
     */
    public safe operator this + (c: int): Point(rank) 
     ...
     */
    public safe operator (c: int) + this: Point(rank) 
     ...
     */
    public safe def equals(other:Any):boolean {
     ...
     */
    public safe operator this < (that: Point(rank)): boolean {
