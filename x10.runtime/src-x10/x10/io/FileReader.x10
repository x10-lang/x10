...
public class FileReader extends InputStreamReader {
    ...
    protected final static class FileInputStream extends InputStream {
        @Native("java", "new java.lang.Object() { x10.core.io.FileInputStream eval(String s) { try { return new x10.core.io.FileInputStream(s); } catch (java.io.FileNotFoundException e) { throw x10.runtime.impl.java.X10Throwable.getCorrespondingX10Exception(e); } } }.eval(#1)")
