 ...
 */
public class Region implements TypeArgument {
	 ...
	 */
	public static Region combine(Set l) {
		int rank = -1;
	...
	public boolean contains(Region r) {
		...
		boolean ret = true;
		for (int i = 0; i < r.dims_.length && ret; ++ i)
			ret = r.dims_[i].contains(dims_[i]);
		return ret;
	}
