...
public class BooleanArray_c extends BooleanArray implements UnsafeContainer, Cloneable {
	 ...
	 * @param safe
	 */
	protected BooleanArray_c(dist d, boolean c) {
		this(d, c, true);
	}
	protected BooleanArray_c(dist d, boolean c, boolean safe) {
		this(d, c, safe, true);
	}
	...
	/**
	 * Return a safe BooleanArray_c initialized with the given local 1-d (Java) boolean array.
	 * FIXME: unimplemented.
