...
public class CharArray_c extends CharArray implements UnsafeContainer, Cloneable {
	 ...
	 * @param safe
	 */
	protected CharArray_c(dist d, char c) {
		this(d, c, true);
	}
	 ...
	 * @param ignored
	 */
	private CharArray_c(dist d, boolean safe, boolean mutable, char[] ignored) {
		super(d);
	...
	/**
	 * Return a safe CharArray_c initialized with the given local 1-d (Java) char array.
	 * FIXME: unimplemented.
