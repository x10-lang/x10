...
/**
 * Test nested finish (fail at third place in three places) handled correctly
 * 
 * @author Murata 8/2014
 */
public class TestNestedFinish extends x10Test  {
    ...
    public def run() {
        ...
        try {
            ...
            val e3 = e2.exceptions(0) as DeadPlaceException;
