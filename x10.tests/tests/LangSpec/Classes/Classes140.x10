/* Current test harness gets confused by packages, but it would be in package classes_not_ferrets;
*/
...
public class Classes140 extends x10Test {
   public def run() : boolean = (new Hook()).run();
   public static def main(args:Rail[String]):void {
        new Classes140().execute();
    }
