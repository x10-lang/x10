/* Current test harness gets confused by packages, but it would be in package ObjectInitialization7p2v_Bad52_MustFailCompile;
*/
...
public class ObjectInitialization7p2v_Bad52_MustFailCompile extends x10Test {
   public def run() : boolean = (new Hook()).run();
   public static def main(args:Rail[String]):void {
        new ObjectInitialization7p2v_Bad52_MustFailCompile().execute();
    }


// file Classes line 4241
