...
2.Define environment variables (only for CPP now
  Define X10C_EXTRA_OPTS
    export X10C_EXTRA_OPTS="-O -WORK_STEALING=true -sourcepath ../../../x10.dist/samples/work-stealing"
  note: the sourcepath is used to point the work-stealing sample file
  Define USE_X10CPP
    export USE_X10CPP=1
