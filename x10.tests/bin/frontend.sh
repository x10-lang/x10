...
"$JAVAC" -cp "$TOP/x10.dist/lib/x10c.jar:../x10.dist/lib/lpg.jar:../x10.dist/lib/antlr-4.5-complete.jar" -d . "$TOP/x10.compiler/src/x10/util/RunTestSuite.java"
...
time nice "$JAVA" \
    -Xmx1G \
    -ea \
    -cp "$TOP:$X10_DIST/lib/x10c.jar:$X10_DIST/lib/lpg.jar:$X10_DIST/lib/antlr-4.5-complete.jar" \
