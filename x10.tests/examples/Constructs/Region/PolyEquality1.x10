...
class PolyEquality1 extends TestRegion {
    ...
    public def run() {
        ...
        val r1 = Region.makeRectangular(0..5, 1..6) as Region(2n);
        val r2 = Region.makeRectangular(1..6, 2..7) as Region(2n);
        val r3 = Region.makeRectangular(1..5, 2..6) as Region(2n);
