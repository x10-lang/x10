...
public class DimCheck_MustFailCompile extends x10Test {
    ...
    public def run(): boolean = {
        ...
        var a1: DistArray[int] = DistArray.make[int](Dist.makeConstant(Region.make(0..2, 0..3), here), ([i]:Point(3))=> i); // ERR ERR ([Semantic Error: The rank of the exploded Point is 3 but it should be 1, Semantic Error: Method make[T](dist: x10.array.Dist, init: (a1:x10.lang.Point{self.x10.lang.Point#rank==dist.x10.array.Dist#region.x10.array.Region#rank})=> T): x10.array.DistArray[T]{self.x10.array.DistArray#dist==dist, self!=null} in x10.array.DistArray cannot be called with arguments [x10.lang.Int](x10.array.Dist{self.x10.array.Dist#region.x10.array.Region#rank==2, self.x10.array.Dist#region.x10.array.Region#rect==true, self.x10.array.Dist#region.x10.array.Region#zeroBased==true}, <anonymous class>);    Invalid Parameter.)
