...
public class SelfFieldsMustBeProperties_MustFailCompile extends x10Test {
	...
	public def run(): boolean = {
	   var a: Test{i==52} = new Test(52) as Test{i==52 && bad} ;  // ERR: Field "bad" is not a property of SelfFieldsMustBeProperties_MustFailCompile.Test.  Only properties may appear unqualified or prefixed with self in a dependent clause.
	    return true;
	}
