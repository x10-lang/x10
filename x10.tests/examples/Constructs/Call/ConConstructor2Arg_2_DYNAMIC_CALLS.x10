...
public class ConConstructor2Arg_2_DYNAMIC_CALLS extends x10Test {
	...
	def this(i:Int) {
		...
		this(new A(i+1),i+1); // ERR ERR ShouldNotBeERR ShouldNotBeERR ShouldNotBeERR ShouldNotBeERR ShouldNotBeERR (Could not find field or local variable "arg273060")
	}
