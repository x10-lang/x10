...
public class ConstrainedTypeTests extends x10Test {
	...
	public def run(): boolean = {
		...
		Console.OUT.println("X10DepTypeSubOne == X10DepTypeClassOne -> "+res1);
		Console.OUT.println("X10DepTypeSubClassOne <: X10DepTypeClassOne -> "+res2);
		Console.OUT.println("X10DepTypeSubClassOne <: Int -> "+(!res3));
		Console.OUT.println("X10DepTypeSubClassOne{a==2} <: X10DepTypeClassOne{p==2} -> "+(!res4));
		Console.OUT.println("X10DepTypeSubClassOne{a==3} <: X10DepTypeClassOne{p==2} -> "+(!res5));
		Console.OUT.println("X10DepTypeSubClassOne{p==2} <: X10DepTypeClassOne{p==2} -> "+res6);
