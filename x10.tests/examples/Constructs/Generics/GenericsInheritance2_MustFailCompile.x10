...
public class GenericsInheritance2_MustFailCompile extends x10Test {
        ...
        @ERR @ERR class C implements I[Int], I[Float] { // todo: message can be better: GenericsInheritance2_MustFailCompile.C should be declared abstract; it does not define m(): x10.lang.Long, which is declared in GenericsInheritance2_MustFailCompile.I
