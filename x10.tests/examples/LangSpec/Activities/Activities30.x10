/* Current test harness gets confused by packages, but it would be in package Activities_AtCopy2;
*/
...
public class Activities30 extends x10Test {
   public def run() : boolean = (new Hook()).run();
   public static def main(var args: Array[String](1)): void = {
        new Activities30().execute();
    }
