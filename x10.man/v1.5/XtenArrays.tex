...
\Xcd{
R}. Such an operation can be lifted pointwise to operate on a \xcd"T"
...
\Xcd{
a} be a value or reference array over base type \xcd"T". Then the
...
\Xcd{
a} be a value or reference array over base type \xcd"T" and
