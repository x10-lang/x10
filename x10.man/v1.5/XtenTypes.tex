...
\index{parametrized closures}
        ...
        constructor or closure. Similarly, a type definition may have
        ...
        (\Sref{TypeDefWhereClause},\Sref{ConstructorWhereClause},\Sref{MethodWhereClause},\Sref{ClosureWhereClause}).
...
\subsection{The interface \Xcd{Ref}}
...
\subsection{The interface \Xcd{Value}}
