...
\multicolumn{4}{c}{\sc  Version 1.01}\\
...
This document revises  Version {\cf 0.41} of the Report,
...
K\authorsc{EMAL} E\authorsc{BCIO\u{G}LU}.
T\authorsc{ONG} W\authorsc{EN} has written many application programs in \Xten{}.
