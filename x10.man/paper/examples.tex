...
system.  Constraints are conjunctions of equalities between
...
(Constraint) & \xcd{c},\xcd{d} &{::=}& \xcd{true} \alt \xcd{t == t} \alt \xcd{c && c}\alt \xcd{T x; c} \\
\\
\end{tabular}
