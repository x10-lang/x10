...
\subsection{Equality constraints: ownership types}
...
\subsection{Presburger constraints: LU factorization}
...
\Xten{} every reference class has a field {\tt location} of type {\tt place} which specifies the location at which this object is located.)
