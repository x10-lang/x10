...
compile-time constants, and \xcd{self}.  Equalities constraints
...
Omega library.~\cite{omega,scale}  A separate implementation
...
types~\cite{ownwership-types}.
Shows a fragment of a \xcd{List} class with ownership types.
