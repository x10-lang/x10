...
the name of a class or interface\footnote{In \Xten{}, primitive types such as \xcd{int} are classes.} \xcd{C}, called the {\em base class}, followed
...
Thus, using the definitions above, \xcd{List(n)}, shown in
...
In this constructor, as well as 
the \xcd{append} and \xcd{rev} method, the return type
...
library~\cite{omega} and the CVC3 solver~\cite{cvc}.
