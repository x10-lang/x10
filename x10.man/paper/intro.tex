...
assuming that
the property list for \xcd{C} specifies the $k$ properties
${\tt x}_1,\ldots,{\tt x}_k$,
...
the \xcd{append} (line 13) and \xcd{rev} (line 18) methods,
the return type
...
Consider the return type of \xcd{filter} (line 22): it specifies
