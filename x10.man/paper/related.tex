...
\lstnewenvironment{displayml}
  {\footnotesize\lstset{language=ML,basicstyle=\tt,tabsize=4,columns=fullflexible,captionpos=b,xleftmargin=1em,xrightmargin=1em}}
  {}
...
introduced. For instance the typing of the {\tt append} operation on
