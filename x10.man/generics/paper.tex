...
Figure~\ref{fig:constraints}.  We elide features of the language
...
Any type that constraints \xcd"T", including the three below,
...
XXX ML has structural types too
...
XXX motivation.  Onerous to write down long types.  Type
definitions let you shorten the types.
...
XXX Writing types down can be onerous.  Type inference wanted.
The following are some thoughts.  We're working on an algorithm
based on generalizing either Java 5's or C\#'s.
...
XXX Want to infer value constraints also.
