...
The body of an  \xcd"async S" is not permitted to contain a 
\xcd"return" statement. Programmers wishing to use
a \xcd"return" statement in \xcd"S" should use the idiom
\xcd"val x=()=>S;async x();" instead.
