...
value of type \Xcd{T}.\footnote{Within the body of
...
structural constraints \todo{really?}). \FXD{} permits
...
%
\todo{implementation} The implementation of generics in \Xten{} is
