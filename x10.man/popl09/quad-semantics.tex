...
\begin{tabular}{r@{\quad}rcl}
  (Program) & {\tt P} &{::=}& $\tbar{L}$ \\
  (Class declaration) & {\tt L} &{::=}& $\tt class~C[\tbar{X}](\tbar{f}:\tbar{G})\{k\}~extends~D~\{~\tbar{M}~\}$ \\
...
${\sf inv}({\tt T})=\wedge\{{\tt k}~s.t~\exists {\tt C}[\tbar{A}],{\tt T}\subtype{\tt C}[\tbar{A}], {\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{F})\{{\tt l}\}~{\tt extends}~{\tt D}~\{~\tbar{M}~\}\in {\tt P}, {\tt k}={\tt l}[\tbar{A}/\tbar{X}]\}$
...
\infrule[OK-Method]
  {{\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}~\{~\tbar{M}~\}\in {\tt P} \andalso
    {\tt def}~{\tt m}[\tbar{Z}](\tbar{x}:\tbar{G})\{{\tt l}\}:{\tt H}={\tt e}\in\tbar{M}\andalso
    \wj{\tbar{X}:\type,\tbar{Z}:\type}{\tbar{G}}\\
    \cj{\tbar{X}:\type,\tbar{Z}:\type,\this:{\tt C}[\tbar{X}],\tbar{x}:\tbar{G}}{\tt l}\andalso
   \tbar{X}:\type,\tbar{Z}:\type,\this:{\tt C}[\tbar{X}],\tbar{x}:\tbar{G},{\tt l}\vdash {\tt e}:{\tt E},{\tt E}\subtype {\tt H}}
  {\vdash{\tt def}~{\tt m}[\tbar{Z}](\tbar{x}:\tbar{G})\{{\tt l}\}:{\tt H}={\tt e}~{\rm OK~in}~{\tt C}[\tbar{X}]}

\infrule[OK-Class]
  {\wjj{\tbar{X}:\type}{\tt C[\tbar{X}]}{\tbar{F}}\andalso
  \cj{\tbar{X}:\type,\tbar{x}:\tbar{F}}{{\tt k}[\tbar{x}/\this.\tbar{f}]} \andalso 
  \tbar{M}~{\rm OK~in}~{\tt C}[\tbar{X}]\andalso 
    \tbar{x}~\rm fresh}
  {\vdash {\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}~\{~\tbar{M}~\}~\rm OK}
\end{minipage}%
...
\quad\typicallabel{XXXXXX}
\infrule[W-Class]
  {{\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}~\{~\tbar{M}~\} \in {\tt P} \andalso \wjj{\Gamma}{{\tt D}[\tbar{A}]}{\tbar{B}}}
  {\wj{\Gamma}{\tt C[\tbar{A},\tbar{B}]}}
\end{minipage}
...
\infrule[S-Class]
  {{\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{G})\{{\tt k}\}~{\tt extends}~{\tt D}~\{~\tbar{M}~\}\in {\tt P}\andalso
  \wjj{\Gamma}{{\tt C}[\tbar{A},\tbar{B}]}{{\tt D}[\tbar{A}]}}
  {\Gamma\vdash {\tt C}[\tbar{A},\tbar{B}]\subtype {\tt D}[\tbar{A}]}
\end{minipage}        
...
\quad\typicallabel{XXXXXX}
\infrule[L-Fields-I]
  {{\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}~\{~\tbar{M}~\}\in {\tt P}
    \andalso \wj{\Gamma}{\tbar{C}[\tbar{A},\tbar{B}]} \andalso
   \Gamma\vdash\fields({\tt D}[\tbar{A}])=\tbar{g}:\tbar{G}}
   {\Gamma\vdash\fields({\tt C}[\tbar{A},\tbar{B}])=\tbar{g},\tbar{f}:\tbar{G},\tbar{F}[\tbar{A},\tbar{B}/\tbar{X}]}

\infrule[L-Method-B]
  {{\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}~\{~\tbar{M}~\}\in {\tt P}
   \andalso
   {\tt def}~{\tt m}[\tbar{Z}](\tbar{x}\ty \tbar{G})\{{\tt l}\}\ty {\tt H}={\tt e}\in \tbar{M} \andalso
   \wjj{\Gamma}{{\tt C}[\tbar{A}]}{\tbar{B}}}
  {\Gamma\vdash {\sf methods}({\tt C}[\tbar{A}]) \ni {\tt m}[\tbar{B}](\tbar{x}:\tbar{G}[\tbar{A},\tbar{B}/\tbar{X},\tbar{Z}])\{{\tt l[\tbar{A},\tbar{B}/\tbar{X},\tbar{Z}]}\}:{\tt H[\tbar{A},\tbar{B}/\tbar{X},\tbar{Z}]}={\tt e}[\tbar{A},\tbar{B}/\tbar{X},\tbar{Z}]}
...
\infrule[L-Method-I]
  {{\tt class}~{\tt C}[\tbar{X}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}~\{~\tbar{M}~\}\in {\tt P}
   ...
   \andalso
   {\tt m}\not\in\tbar{M}}
  {\vdash {\sf methods}({\tt C}[\tbar{A},\tbar{B}]) \ni {\tt m}[\tbar{C}](\tbar{x}:\tbar{G})\{{\tt l}\}:{\tt H}={\tt e}}
