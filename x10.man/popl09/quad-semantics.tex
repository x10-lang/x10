...
In practice, it makes sense to distinguish the functions of the constraint language from the functions of the base language and define the {\sc T-Fun} typing judgment on a case-by-case basis to lift expressions of the base language to the constraint language.
