...
For instance, if $\mathcal{A}$ defines the type {\tt int}, integer litterals, and the usual arithmetic operators we can declare:
...
In pratice, it make sense to distinguish the functions of the contraint language from the function of the base language and define the {\sc T-Fun} method on a case-by-case basis to lift expressions of the base language to the constraint language.
