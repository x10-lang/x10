...
Whatever the extension, to preserve the soundness of the type system and the property of principal types---that is, the proof structure we have previously described---one need only ensure the following:
\begin{enumerate}
