...
\infrule[\RInvk]
	{\vdash{\sf methods}({\tt C}[\tbar{V}]) \ni {\tt m}[\tbar{W}](\tbar{x}:\tbar{G})\{{\tt k}\}:{\tt H}={\tt e}}
	{\new~{\tt C}[\tbar{V}](\tbar{v}).{\tt m}[\tbar{W}](\tbar{a})\derives {\tt e}[\new~{\tt C}[\tbar{V}](\tbar{v}),\tbar{W},\tbar{a}/\this,\tbar{Y},\tbar{x}]}
...
\infrule[\RCast]
	...
	{\new~{\tt C}[\tbar{V}](\tbar{v})~\as~{\tt W}\derives\new~{\tt C}[\tbar{V}](\tbar{v})}
\end{minipage}
...
\infrule[OK-Method]
  {{\tt class}~{\tt C}[\tbar{X}\cdot\tbar{Y}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}[\tbar{X}]~\{~\tbar{M}~\}\in {\tt P} \andalso
   ...
   \tbar{X}\cdot\tbar{Y}\cdot\tbar{Z}:\type,\this:{\tt C}[\tbar{X}\cdot\tbar{Y}],\tbar{x}:\tbar{G},{\tt l}\vdash {\tt e}:{\tt E},{\tt E}\subtype {\tt H}}
  {\vdash{\tt def}~{\tt m}[\tbar{Z}](\tbar{x}:\tbar{G})\{{\tt l}\}:{\tt H}={\tt e}~{\rm OK~in}~{\tt C}[\tbar{X}\cdot\tbar{Y}]}

\infrule[OK-Class]
  {\wj{\tbar{X}\cdot\tbar{Y}:\type}{{\tt C[\tbar{X}\cdot\tbar{Y}]}} \andalso
   \wj{\tbar{X}\cdot\tbar{Y}:\type}{\tbar{F}}\andalso 
    \tbar{x}~\rm fresh\\
...
\infrule[W-Class]
  {{\tt class}~{\tt C}[\tbar{X}\cdot\tbar{Y}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}[\tbar{X}]~\{~\tbar{M}~\} \in {\tt P} \andalso \wj{\Gamma}{{\tt D}[\tbar{A}]}\andalso \wj{\Gamma}{\tbar{B}}}
  {\wj{\Gamma}{\tt C[\tbar{A}\cdot\tbar{B}]}}

\infrule[W-Dep]
        {\wj{\Gamma}{\tt T} \andalso \cjj{\Gamma, \self \ty {\tt T}}{\tt c}{\bullet}}
	{\wj{\Gamma}{{\tt T}\{{\tt c}\}}}
...
\infrule[S-Exists-L]
  {\wj{\Gamma}{\tt U} \andalso \Gamma,{\tt x}:{\tt U}\vdash {\tt S}\subtype {\tt T} \andalso {\tt x}~\rm not~free~in~{\tt T}}
  {\Gamma\vdash\exists {\tt x}:{\tt U}.~{\tt S}\subtype {\tt T}}
\end{minipage}%
\begin{minipage}{.5\textwidth}
\quad\typicallabel{XXXXX}
\infrule[S-Const-R]
	{\wj{\Gamma}{{\tt T}\{{\tt c}\}}\andalso\Gamma,\self:{\tt S}\vdash {\tt c}\andalso\Gamma\vdash {\tt S}\subtype {\tt T}}
...
\quad\typicallabel{XXXXXX}
\infrule[L-Member-E]
  {\Gamma,{\tt y}:{\tt T},{\tt x}:{\tt U}\vdash {\tt x}~\has~{\tt I}}
...
\infrule[L-Method-B]
  {{\tt class}~{\tt C}[\tbar{X}\cdot\tbar{Y}](\tbar{f}:\tbar{F})\{{\tt k}\}~{\tt extends}~{\tt D}[\tbar{X}]~\{~\tbar{M}~\}\in {\tt P}
   ...
   \wj{\Gamma}{\tbar{A}\cdot\tbar{B}\cdot\tbar{E}}}
  {\Gamma\vdash {\sf methods}({\tt C}[\tbar{A}\cdot\tbar{B}]) \ni {\tt m}[\tbar{E}](\tbar{x}:\tbar{G}[\tbar{A}\cdot\tbar{B}\cdot\tbar{E}/\tbar{X}\cdot\tbar{Y}\cdot\tbar{Z}])\{{\tt l[\tbar{A}\cdot\tbar{B}\cdot\tbar{E}/\tbar{X}\cdot\tbar{Y}\cdot\tbar{Z}]}\}:{\tt H[\tbar{A}\cdot\tbar{B}\cdot\tbar{E}/\tbar{X}\cdot\tbar{Y}\cdot\tbar{Z}]}={\tt e}[\tbar{A}\cdot\tbar{B}\cdot\tbar{E}/\tbar{X}\cdot\tbar{Y}\cdot\tbar{Z}]}
...
\infrule[L-Method-H]
  {\Gamma\vdash {\sf methods}({\tt C}[\tbar{A}]) \ni {\tt m}[\tbar{B}](\tbar{y}:\tbar{G})\{{\tt l}\}:{\tt H}={\tt e}}
  {\Gamma,{\tt x}:{\tt C}[\tbar{A}]\vdash{\tt x}~\has~{\tt m}[\tbar{B}](\tbar{y}:\tbar{G})\{{\tt l}[{\tt x}/\this]\}:{\tt H}[{\tt x}/\this]={\tt e}[{\tt x}/\this]}
\end{minipage}%
