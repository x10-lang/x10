...
It is also possible for a program to specify constraints such as ``${\tt x}\extends{\tt A}, {\tt x}\extends{\tt D}$'' that are inconsistent with the class hierarchy---they admit no valuations where the variables take on classes as values.
