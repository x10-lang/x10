...
\begin{enumerate}
	...
	\item Typing:\\
	  ...
	  $\Gamma\vdash {\tt I}~//~{\tt J}$ \hfill member {\tt I} overrides member {\tt J} in $\Gamma$\\
...
\infrule[H-Method]
  ...
  {\Gamma,{\tt x}\ty{\tt C}[\tbar{A}]\vdash{\tt x}~\has~\minst{B}{z}{G\theta}{d\theta}{H\theta}{e\theta}}
\end{minipage}%
...
\infrule[T-Invk]
	{\Gamma\vdash {\tt e}\ty{\tt T},\tbar{a}\ty\tbar{U} \andalso
	  ...
	  \Gamma,{\tt x}\ty{\tt T},\tbar{y}\ty{\tt U}\vdash {\tt x}~\has~\minst{A}{y}{G}{c}{H}{b},{\tt c},\tbar{y}\subtype\tbar{G}}
...
\quad\typicallabel{XXXXXX}
\infax[O-Field]
  {\Gamma\vdash {\tt f}\ty{\tt F} ~//~ {\tt f}\ty{\tt F}}
\end{minipage}%
...
\infrule[O-Method]
  ...
  {\Gamma\vdash \minst{Y}{x}{G}{d}{H}{e} ~//~ \minst{Y}{x}{G'}{d'}{H'}{e'}}
\end{minipage}%
...
\infrule[OK-Method]
  {\cdecl \andalso
    ...
    \tbar{X}\ty*,{\tt c},\this\ty{\tt D}[\tbar{E}],\tbar{Y}\ty*\vdash\this~\has~\minst{Y}{x}{G'}{d'}{H'}{e'} ~\Rightarrow~
    \Gamma\vdash \minst{Y}{x}{G}{d}{H}{e} ~//~ \minst{Y}{x}{G'}{d'}{H'}{e'}}
  {\vdash\mdecl{Y}{x}{G}{d}{H}{e}~{\rm OK~in}~{\tt C}[\tbar{X}]}
