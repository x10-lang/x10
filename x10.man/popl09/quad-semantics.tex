...
We distinguish members available on variables from class members to prepare for the introduction of generic types later. For now, ${\tt x}:{\tt C}~\underline\has~{\tt I}[{\tt x}/\this]$ iff ${\tt C}~\has~{\tt I}$.
