...
\newcommand\extends{\mathrel{\tt <=}}
\newcommand\super{\mbox{\tt >=}}
...
\authorinfo{Nathaniel Nystrom \and Igor Peshansky \and Vijay
Saraswat \and Olivier Tardieu}{IBM T.~J. Watson Research
Center, P.O. Box 704, Yorktown Heights NY 10598 USA}
  {\{nystrom,igorp,vsaraswa,tardieu\}@us.ibm.com}
