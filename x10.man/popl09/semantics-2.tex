...
variables are considered equivalent up to $\alpha$-renaming.
...
We will use an auxiliary judgment:

\infrule[is]
{\Gamma \vdash e:C\{c\} \andalso \Gamma, c \vdash \self=d \andalso \self \not\equiv d}
{\Gamma \vdash e\ \is\ d}

This judgment lets us find a {\em static designator} $d$ for a
well-typed expression $e$. We will formulate the typing judgment in
