...
name of a class and \xcd"c" is a constraint on the properties of
\xcd"C" and the immutable state in scope at the type.  The
...
may have additional
constraints, or \emph{guards}, on the method parameters which must be satisfied for access.
