...
\subsection{Parameters vs. properties}

Parameters not type properties.
Definition-side variance.

\subsection{Contracts}

Tying constraints to types: avoids well-foundedness problems,
mutability problems.  Contracts do not allow
parametrizing a class on a constraint.

\subsection{Avoiding run-time constraint solving}
