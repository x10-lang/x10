...
rather properties are members and types constructed by
constraining these properties.  Unlike dependent classes,
type properties do not affect method dispatching.
