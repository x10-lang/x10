...
Structs are instances of {\em struct types} (\Sref{StructClasses}). They are
immutable and may be freely copied from place to place. Further, they may be
allocated inline, \ie, using only as much memory as necessary to hold the
fields of the struct (and any additional memory necessary to satisfy alignment
