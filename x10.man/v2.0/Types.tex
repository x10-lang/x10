...
\xcd"c" is true whenever \xcd"d" is, and vice versa. 
...
\xcd"c" implies \xcd"d".  
%%TYPES-CONSTR-LL%% When this subtyping relationship holds, 
%%TYPES-CONSTR-LL%% $\LL{\mbox{\Xcd{C\{c\}}}}$ is a
%%TYPES-CONSTR-LL%% subset of $\LL{\mbox{\Xcd{C\{d\}}}}$. 
All dependent types
