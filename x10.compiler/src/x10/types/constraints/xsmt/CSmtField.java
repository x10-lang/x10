...
public class CSmtField extends XSmtField<Def> implements CField, Typed{
    ...
    public CSmtField(XVar<Type> r, MethodDef fi) {this(r, fi, false);}
    public CSmtField(XVar<Type> r, MethodDef fi, boolean hidden) {super(r, fi, hidden);}

    public CSmtField(XVar<Type> r, FieldDef fi) {this(r, fi, false);}
    public CSmtField(XVar<Type> r, FieldDef fi, boolean hidden)  {super(r, fi, hidden);}
     ...
     */
    @Override
    public CSmtField copyReceiver(XVar<Type> newReceiver) {
	...
	@Override
	public CSmtField subst(XTerm<Type> x, XVar<Type> v) {
