...
public class X10CCompilerOptions extends x10.X10CompilerOptions {
    ...
    public static final String math_jar = System.getProperty("x10c.math.jar", "commons-math3-3.6.1.jar");
    public static final String log_jar = System.getProperty("x10c.log.jar",  "commons-logging-1.2.jar");
    public static final String ecj_jar = System.getProperty("x10c.ecj.jar", "ecj-4.7.2.jar");
