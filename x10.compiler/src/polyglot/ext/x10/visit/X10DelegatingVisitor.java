...
import polyglot.ext.jl.ast.AmbPrefix_c;
import polyglot.ext.jl.ast.AmbQualifierNode_c;
import polyglot.ext.jl.ast.AmbReceiver_c;
...
import polyglot.ext.jl.ast.Branch_c;
...
import polyglot.ext.jl.ast.Empty_c;
...
import polyglot.ext.jl.ast.SwitchBlock_c;
import polyglot.ext.jl.ast.Switch_c;
import polyglot.ext.jl.ast.Synchronized_c;
import polyglot.ext.jl.ast.Term_c;
import polyglot.ext.jl.ast.Throw_c;
import polyglot.ext.jl.ast.Try_c;
...
import polyglot.ext.x10.ast.CompilerTest_c;
...
public class X10DelegatingVisitor {
	...
	public void visitAppropriate(JL n) {
		...
		if (n instanceof X10TypeNode_c) { visit((X10TypeNode_c)n); return; }
		...
		if (n instanceof X10AmbTypeNode_c) { visit((X10AmbTypeNode_c)n); return; }
		...
		if (n instanceof CompilerTest_c) { visit((CompilerTest_c)n); return; }
	...
	public void visit(Node_c n) { visit((Node)n); }
		...
		public void visit(Term_c n) { visit((Node_c)n); }
			...
			public void visit(Expr_c n) { visit((Term_c)n); }
				...
				public void visit(ArrayConstructor_c n) { visit((Expr_c)n); }
			...
			public void visit(FieldDecl_c n) { visit((Term_c)n); }
				public void visit(CompilerTest_c n) { visit((FieldDecl_c)n); }
			...
			public void visit(TypeNode_c n) { visit((Term_c)n); }
				public void visit(AmbTypeNode_c n) { visit((TypeNode_c)n); }
					public void visit(X10AmbTypeNode_c n) { visit((AmbTypeNode_c)n); }
				...
				public void visit(X10TypeNode_c n) { visit((TypeNode_c)n); }
