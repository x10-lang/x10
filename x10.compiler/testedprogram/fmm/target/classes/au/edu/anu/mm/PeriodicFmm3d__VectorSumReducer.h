#ifndef __AU_EDU_ANU_MM_PERIODICFMM3D__VECTORSUMREDUCER_H
#define __AU_EDU_ANU_MM_PERIODICFMM3D__VECTORSUMREDUCER_H
...
class PeriodicFmm3d__VectorSumReducer   {
    ...
    au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer* operator->() { return this; }
    
    static x10aux::itable_entry _itables[3];
    
    x10aux::itable_entry* _getITables() { return _itables; }
    
    static x10::lang::Any::itable<au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer > _itable_0;
    
    static x10::lang::Reducible<x10x::vector::Vector3d>::itable<au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer > _itable_1;
    
    static x10aux::itable_entry _iboxitables[3];
    
    x10aux::itable_entry* _getIBoxITables() { return _iboxitables; }
    
    static au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer _alloc(){au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer t; return t; }
    ...
    x10x::vector::Vector3d __apply(x10x::vector::Vector3d a, x10x::vector::Vector3d b);
    ...
    x10_boolean equals(au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer other) {
    ...
    x10_boolean _struct_equals(au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer other) {
        
        //#line 343 "/home/zhangsa/x10/x10programs/anuchem/apps/fmm/src/au/edu/anu/mm/PeriodicFmm3d.x10": x10.ast.X10Return_c
        return true;
        
    }
    au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer au__edu__anu__mm__PeriodicFmm3d__VectorSumReducer____au__edu__anu__mm__PeriodicFmm3d__VectorSumReducer__this(
      ) {
    ...
    static au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer _make(
             ) {
    ...
    void __fieldInitializers24244() {
        
        //#line 343 "/home/zhangsa/x10/x10programs/anuchem/apps/fmm/src/au/edu/anu/mm/PeriodicFmm3d.x10": x10.ast.X10FieldAssign_c
        (*this)->FMGL(X10__object_lock_id0) = ((x10_int)-1);
    }
    
    static void _serialize(au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer this_, x10aux::serialization_buffer& buf);
    
    static au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer _deserialize(x10aux::deserialization_buffer& buf) {
        au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer this_;
...
#endif // AU_EDU_ANU_MM_PERIODICFMM3D__VECTORSUMREDUCER_H

namespace au { namespace edu { namespace anu { namespace mm { 
class PeriodicFmm3d__VectorSumReducer;
} } } } 

#ifndef AU_EDU_ANU_MM_PERIODICFMM3D__VECTORSUMREDUCER_H_NODEPS
#define AU_EDU_ANU_MM_PERIODICFMM3D__VECTORSUMREDUCER_H_NODEPS
#ifndef AU_EDU_ANU_MM_PERIODICFMM3D__VECTORSUMREDUCER_H_GENERICS
#define AU_EDU_ANU_MM_PERIODICFMM3D__VECTORSUMREDUCER_H_GENERICS
inline x10_int au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer::FMGL(X10__class_lock_id1__get)() {
    if (FMGL(X10__class_lock_id1__status) != x10aux::INITIALIZED) {
        FMGL(X10__class_lock_id1__init)();
    }
    return au::edu::anu::mm::PeriodicFmm3d__VectorSumReducer::FMGL(X10__class_lock_id1);
}

#endif // AU_EDU_ANU_MM_PERIODICFMM3D__VECTORSUMREDUCER_H_GENERICS
#endif // __AU_EDU_ANU_MM_PERIODICFMM3D__VECTORSUMREDUCER_H_NODEPS
