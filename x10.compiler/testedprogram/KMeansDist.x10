...
public class KMeansDist {
    ...
    public static def main (Array[String]) {
        ...
        /*this field may need protection, will be updated in multiple activities*/
	...
	val old_central_clusters = new Array[Float](CLUSTERS*DIM);
        ...
        for (i in 1..ITERATIONS) {
            ...
            finish {
                // reset state
                /*the following access may not need locks*/
            ...
            finish {
                ...
                for (d in points_dist.places()) async {
                    ...
                    at (there) atomic(central_clusters_gr, central_cluster_counts_gr)
                    {
                        for (var j:Int=0 ; j<DIM*CLUSTERS ; ++j) {
