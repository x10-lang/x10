...
public class UTS {
  ...
  static class BinomialState {
    ...
    public def this (q:Double, m:Int) {
      ...
      this.state = here == Place.FIRST_PLACE ? STATE_HOME_PLACE : STATE_STEALING;
    ...
    public final def hasWork () = false;
    ...
    public final def main (st:PLH, b0:Int, rng:SHA1Rand) : Int {
      ...
      finish {
        ...
        while (true) {
          ...
          Console.OUT.println(here+": Could not steal work.");
